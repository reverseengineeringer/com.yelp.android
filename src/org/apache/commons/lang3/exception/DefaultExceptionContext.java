  ...
  implements Serializable, a
{
  ...
  public List<Object> getContextValues(String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (org.apache.commons.lang3.b.a(paramString, (CharSequence)localPair.getKey())) {
      ...
      if (localIterator.hasNext())
      {
        ...
        for (;;)
        {
          ...
          catch (Exception paramString)
          {
            for (;;)
            {
              paramString = "Exception thrown on toString(): " + b.a(paramString);
            }
          }
        }
      }
  ...
  public DefaultExceptionContext setContextValue(String paramString, Object paramObject)
  {
    Iterator localIterator = contextValues.iterator();
    while (localIterator.hasNext()) {
      if (org.apache.commons.lang3.b.a(paramString, (CharSequence)((Pair)localIterator.next()).getKey())) {
