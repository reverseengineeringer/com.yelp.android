...
public class zze
{
  ...
  public static int isGooglePlayServicesAvailable(Context paramContext)
  {
    ...
    try
    {
      paramContext.getResources().getString(a.e.common_google_play_services_unknown_issue);
    ...
    label180:
    int i = jy.a(GOOGLE_PLAY_SERVICES_VERSION_CODE);
    if (jy.a(versionCode) < i)
    {
  ...
  public static boolean zzap(Context paramContext)
  {
    ...
    return (kf.j()) && (paramContext.hasSystemFeature("cn.google"));
  }
