  ...
  extends zze
{
  ...
  private static void zza(int paramInt, Context paramContext, String paramString)
  {
    ...
    if (str == null) {
      localObject1 = ((Resources)localObject2).getString(a.e.common_google_play_services_notification_ticker);
    }
    ...
    {
      zzx.zzab(kf.d());
      localObject1 = new Notification.Builder(paramContext).setSmallIcon(a.b.common_ic_googleplayservices).setPriority(2).setAutoCancel(true).setStyle(new Notification.BigTextStyle().bigText((String)localObject1 + " " + str)).addAction(a.b.common_full_open_on_phone, ((Resources)localObject2).getString(a.e.common_open_on_phone), (PendingIntent)localObject3).build();
      if (!zzbw(paramInt)) {
        break label366;
      }
      zzafQ.set(false);
    ...
    for (paramInt = 10436;; paramInt = 39789)
    {
      ...
      return;
      localObject2 = ((Resources)localObject2).getString(a.e.common_google_play_services_notification_ticker);
      if (kf.a())
      {
      ...
      localObject1 = new x.d(paramContext).a(17301642).c((CharSequence)localObject2).a(System.currentTimeMillis()).a(true).a((PendingIntent)localObject3).a((CharSequence)localObject1).b(str).a();
      break;
    }
    label373:
