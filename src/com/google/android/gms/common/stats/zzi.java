...
public class zzi
{
  ...
  private static int getLogLevel()
  {
    ...
    {
      if (js.a()) {
        return ((Integer)zzc.zzb.zzanz.c()).intValue();
      }
  ...
  public void zza(Context paramContext, String paramString1, int paramInt1, String paramString2, String paramString3, int paramInt2, List<String> paramList, long paramLong)
  {
    ...
    paramString1 = new WakeLockEvent(l, paramInt1, paramString2, paramInt2, paramList, paramString1, SystemClock.elapsedRealtime(), jx.a(paramContext), paramString3, paramContext.getPackageName(), jx.b(paramContext), paramLong);
    try
    {
