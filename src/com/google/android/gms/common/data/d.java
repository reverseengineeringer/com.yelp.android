...
public abstract class d
{
  ...
  {
    JG = ((DataHolder)jx.i(paramDataHolder));
    as(paramInt);
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject instanceof d))
    {
      ...
      bool1 = bool2;
      if (jv.equal(Integer.valueOf(KZ), Integer.valueOf(KZ)))
      {
        bool1 = bool2;
        if (jv.equal(Integer.valueOf(La), Integer.valueOf(La)))
        {
          bool1 = bool2;
          if (JG == JG) {
            bool1 = true;
  ...
  public int hashCode()
  {
    return jv.hashCode(new Object[] { Integer.valueOf(KZ), Integer.valueOf(La), JG });
  }
