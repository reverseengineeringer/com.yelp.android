  ...
  implements GoogleApiClient
{
  ...
  private final jm.b Km = new c.3(this);
  ...
  {
    kc.Nu.c(paramGoogleApiClient).setResultCallback(new c.7(this, paramf, paramBoolean, paramGoogleApiClient));
  }
  ...
  public <A extends Api.a, R extends Result, T extends BaseImplementation.a<R, A>> T a(T paramT)
  {
    ...
    //   4: invokeinterface 268 1 0
    //   9: aload_0
    //   10: invokevirtual 347	com/google/android/gms/common/api/c:isConnected	()Z
    //   13: ifeq +20 -> 33
    //   16: aload_0
    //   17: aload_1
    //   18: invokevirtual 462	com/google/android/gms/common/api/c:b	(Lcom/google/android/gms/common/api/BaseImplementation$a;)Lcom/google/android/gms/common/api/BaseImplementation$a;
    //   21: pop
    //   22: aload_0
