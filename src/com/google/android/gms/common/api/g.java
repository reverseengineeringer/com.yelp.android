  ...
  implements DialogInterface.OnCancelListener, LoaderManager.LoaderCallbacks<ConnectionResult>
{
  ...
  public void a(r<ConnectionResult> paramr, ConnectionResult paramConnectionResult)
  {
    ...
    a(paramr.getId(), paramConnectionResult);
  }
  ...
  public r<ConnectionResult> onCreateLoader(int paramInt, Bundle paramBundle)
  {
    return new g.a(getActivity(), KG.get(paramInt)).KH);
  }
  
  public void onLoaderReset(r<ConnectionResult> paramr)
  {
    if (paramr.getId() == KD) {
      gR();
    }
