  ...
  implements Parcelable.Creator<GetServiceRequest>
{
  static void zza(GetServiceRequest paramGetServiceRequest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 4, zzaln, false);
    zzb.zza(paramParcel, 5, zzalo, false);
    zzb.zza(paramParcel, 6, zzalp, paramInt, false);
    zzb.zza(paramParcel, 7, zzalq, false);
    zzb.zza(paramParcel, 8, zzalr, paramInt, false);
