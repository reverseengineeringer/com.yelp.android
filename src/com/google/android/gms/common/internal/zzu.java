...
public abstract interface zzu
  extends IInterface
{
  public abstract c zza(c paramc, int paramInt1, int paramInt2)
    throws RemoteException;
  
  public abstract c zza(c paramc, SignInButtonConfig paramSignInButtonConfig)
    throws RemoteException;
    ...
    implements zzu
  {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        paramParcel1 = zza(c.a.a(paramParcel1.readStrongBinder()), paramParcel1.readInt(), paramParcel1.readInt());
      ...
      {
        localc = zza(localc, paramParcel1);
        paramParcel2.writeNoException();
      ...
      implements zzu
    {
      ...
      /* Error */
      public c zza(c paramc, int paramInt1, int paramInt2)
        throws RemoteException
      {
        // Byte code:
      ...
      /* Error */
      public c zza(c paramc, SignInButtonConfig paramSignInButtonConfig)
        throws RemoteException
      {
        // Byte code:
        //   0: invokestatic 30	android/os/Parcel:obtain	()Landroid/os/Parcel;
