...
public class b
{
  ...
  public int a(int paramInt, String paramString1, String paramString2)
  {
    ...
    {
      if (c) {
        gz.d("IInAppBillingService is not available, please add com.android.vending.billing.IInAppBillingService to project.", paramString1);
      }
    }
    return 5;
  }
  ...
  public void a(IBinder paramIBinder)
  {
    ...
    {
      while (!c) {}
      gz.d("IInAppBillingService is not available, please add com.android.vending.billing.IInAppBillingService to project.");
    }
  }
