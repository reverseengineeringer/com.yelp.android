  ...
  extends ey.a
{
  ...
  protected String a(String paramString, HashMap<String, String> paramHashMap)
  {
    ...
    catch (PackageManager.NameNotFoundException localNameNotFoundException)
    {
      for (;;)
      {
        gz.d("Error to retrieve app version", localNameNotFoundException);
        str2 = "";
      }
    }
  ...
  void b()
  {
    ...
    {
      gz.d("Google Conversion Tracking SDK 1.2.0 or above is required to report a conversion.");
      return;
    }
    ...
    {
      gz.d("Fail to report a conversion.", localException);
    }
  }
