  ...
  implements Parcelable.Creator<AdRequestParcel>
{
  static void a(AdRequestParcel paramAdRequestParcel, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzb(paramParcel, 5, e, false);
    zzb.zza(paramParcel, 6, f);
    zzb.zzc(paramParcel, 7, g);
    zzb.zza(paramParcel, 8, h);
    zzb.zza(paramParcel, 9, paramAdRequestParcel.i, false);
    zzb.zza(paramParcel, 10, j, paramInt, false);
    zzb.zza(paramParcel, 11, k, paramInt, false);
    zzb.zza(paramParcel, 12, l, false);
    zzb.zza(paramParcel, 13, m, false);
    zzb.zza(paramParcel, 14, n, false);
    zzb.zzb(paramParcel, 15, o, false);
    zzb.zza(paramParcel, 17, q, false);
    zzb.zza(paramParcel, 16, p, false);
    zzb.zza(paramParcel, 18, r);
