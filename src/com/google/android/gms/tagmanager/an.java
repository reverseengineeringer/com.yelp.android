  ...
  implements c.c
{
  ...
  {
    this(paramContext, jv.d(), "google_tagmanager.db", 2000, Executors.newSingleThreadExecutor());
  }
  
  an(Context paramContext, jt paramjt, String paramString, int paramInt, Executor paramExecutor)
  {
    c = paramContext;
    e = paramjt;
    f = paramInt;
    b = paramExecutor;
    d = new a(c, paramString);
  }
  ...
  {
    // Byte code:
    //   0: new 101	java/io/ByteArrayInputStream
    //   3: dup
    //   4: aload_1
    //   5: invokespecial 104	java/io/ByteArrayInputStream:<init>	([B)V
    //   8: astore_3
    //   9: new 106	java/io/ObjectInputStream
    //   12: dup
    //   13: aload_3
    //   14: invokespecial 109	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   17: astore_1
    //   18: aload_1
    //   19: invokevirtual 113	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   22: astore_2
    //   23: aload_1
    //   24: ifnull +7 -> 31
    //   27: aload_1
    //   28: invokevirtual 116	java/io/ObjectInputStream:close	()V
    //   31: aload_3
    //   32: invokevirtual 117	java/io/ByteArrayInputStream:close	()V
    //   35: aload_2
    //   36: areturn
    //   37: astore_1
    //   38: aconst_null
    ...
    //   41: ifnull +7 -> 48
    //   44: aload_1
    //   45: invokevirtual 116	java/io/ObjectInputStream:close	()V
    //   48: aload_3
    //   49: invokevirtual 117	java/io/ByteArrayInputStream:close	()V
    //   52: aconst_null
    //   53: areturn
    //   54: astore_1
    //   55: aconst_null
    ...
    //   61: ifnull +7 -> 68
    //   64: aload_1
    //   65: invokevirtual 116	java/io/ObjectInputStream:close	()V
    //   68: aload_3
    //   69: invokevirtual 117	java/io/ByteArrayInputStream:close	()V
    //   72: aconst_null
    //   73: areturn
    //   74: astore_1
    //   75: aconst_null
    ...
    //   81: ifnull +7 -> 88
    //   84: aload_1
    //   85: invokevirtual 116	java/io/ObjectInputStream:close	()V
    //   88: aload_3
    //   89: invokevirtual 117	java/io/ByteArrayInputStream:close	()V
    //   92: aload_2
    //   93: athrow
    //   94: astore_1
    //   95: goto -3 -> 92
  ...
  private List<c.a> a(List<b> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      localArrayList.add(new c.a(a, a(b)));
    }
  ...
  private void a(int paramInt)
  {
    ...
    if (paramInt > 0)
    {
      ...
      m.c("DataLayer store full, deleting " + localList.size() + " entries to make room.");
  ...
  private void a(long paramLong)
  {
    ...
    try
    {
      ...
      m.d("Deleted " + i + " expired items");
      return;
    }
    catch (SQLiteException localSQLiteException)
    {
      m.b("Error deleting old entries.");
    }
  }
  ...
  private void a(String[] paramArrayOfString)
  {
    ...
    {
      m.b("Error deleting entries " + Arrays.toString(paramArrayOfString));
    }
  }
  ...
  private List<String> b(int paramInt)
  {
    ...
    //   10: ifgt +12 -> 22
    //   13: ldc_w 289
    //   16: invokestatic 94	com/google/android/gms/tagmanager/m:b	(Ljava/lang/String;)V
    //   19: aload 6
    //   21: areturn
    //   22: aload_0
    //   23: ldc_w 291
    //   26: invokespecial 201	com/google/android/gms/tagmanager/an:a	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore_3
    //   30: aload_3
    //   31: ifnonnull +6 -> 37
    //   34: aload 6
    ...
    //   46: ldc 34
    //   48: aastore
    //   49: invokestatic 46	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   52: astore 4
    //   54: iload_1
    ...
    //   61: ldc 32
    //   63: iconst_1
    //   64: anewarray 42	java/lang/String
    //   67: dup
    //   68: iconst_0
    //   69: ldc 34
    //   71: aastore
    ...
    //   155: aload 4
    //   157: astore_3
    //   158: new 167	java/lang/StringBuilder
    //   161: dup
    //   162: invokespecial 168	java/lang/StringBuilder:<init>	()V
    //   165: ldc_w 320
    //   168: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   171: aload 5
    //   173: invokevirtual 323	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   176: invokevirtual 174	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   179: invokevirtual 185	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   182: invokestatic 94	com/google/android/gms/tagmanager/m:b	(Ljava/lang/String;)V
    //   185: aload 4
    //   187: ifnull -40 -> 147
    //   190: aload 4
  ...
  private List<b> b(List<c.a> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    paramList = paramList.iterator();
    while (paramList.hasNext())
    {
      ...
      localArrayList.add(new b(a, a(b)));
    }
    return localArrayList;
  }
  ...
  private void b(List<b> paramList, long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 73	com/google/android/gms/tagmanager/an:e	Lcom/google/android/gms/internal/jt;
    //   6: invokeinterface 278 1 0
    //   11: lstore 4
    //   13: aload_0
    //   14: lload 4
    //   16: invokespecial 280	com/google/android/gms/tagmanager/an:a	(J)V
    //   19: aload_0
    //   20: aload_1
    //   21: invokeinterface 177 1 0
    //   26: invokespecial 336	com/google/android/gms/tagmanager/an:a	(I)V
    //   29: aload_0
    //   30: aload_1
    //   31: lload 4
    //   33: lload_2
    //   34: ladd
    //   35: invokespecial 338	com/google/android/gms/tagmanager/an:c	(Ljava/util/List;J)V
    //   38: aload_0
    //   39: invokespecial 286	com/google/android/gms/tagmanager/an:e	()V
    //   42: aload_0
    //   43: monitorexit
    //   44: return
    //   45: astore_1
    //   46: aload_0
    //   47: invokespecial 286	com/google/android/gms/tagmanager/an:e	()V
    //   50: aload_1
    //   51: athrow
    //   52: astore_1
    //   53: aload_0
  ...
  private int d()
  {
    ...
    for (;;)
    {
      ...
      catch (SQLiteException localSQLiteException)
      {
        ...
        m.b("Error getting numStoredEntries");
        return 0;
      }
      finally
      {
  ...
  public void a(final List<c.a> paramList, final long paramLong)
  {
    ...
    b.execute(new Runnable()
    {
      public void run()
      {
        an.a(an.this, paramList, paramLong);
      }
    });
  }
    ...
    extends SQLiteOpenHelper
  {
    ...
    public SQLiteDatabase getWritableDatabase()
    {
      ...
      catch (SQLiteException localSQLiteException)
      {
        ...
        {
          Object localObject2;
          an.b(an.this).getDatabasePath("google_tagmanager.db").delete();
        }
      }
