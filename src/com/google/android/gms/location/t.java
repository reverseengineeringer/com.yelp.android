  ...
  implements Parcelable.Creator<LocationSettingsRequest>
{
  static void a(LocationSettingsRequest paramLocationSettingsRequest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zzc(paramParcel, 1, paramLocationSettingsRequest.b(), false);
    zzb.zzc(paramParcel, 1000, paramLocationSettingsRequest.a());
    zzb.zza(paramParcel, 2, paramLocationSettingsRequest.c());
    zzb.zza(paramParcel, 3, paramLocationSettingsRequest.d());
...
/* Location:
 * Qualified Name:     com.google.android.gms.location.t
