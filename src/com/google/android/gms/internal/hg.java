...
public class hg
{
  ...
  private void a()
  {
    ...
    {
      gz.c("Can not create dialog without Activity Context");
      return;
    }
    ...
    localBuilder.setPositiveButton("Share", new DialogInterface.OnClickListener()
    {
      ...
      {
        s.e().a(hg.a(hg.this), Intent.createChooser(new Intent("android.intent.action.SEND").setType("text/plain").putExtra("android.intent.extra.TEXT", str), "Share via"));
      }
    });
  ...
  static String b(String paramString)
  {
    ...
    do
    {
      ...
      localObject = s.e().a((Uri)localObject);
