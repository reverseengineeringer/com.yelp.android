  ...
  implements fc
{
  ...
  public static fc a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof fc))) {
      return (fc)localIInterface;
    }
    ...
    implements fc
  {
      ...
      throws RemoteException
    {
      ...
      //   14: aload_0
      //   15: getfield 17	com/google/android/gms/internal/fc$a$a:a	Landroid/os/IBinder;
      //   18: iconst_2
      //   19: aload_2
      //   20: aload_3
      //   21: iconst_0
      ...
      //   36: ifeq +26 -> 62
      //   39: getstatic 65	android/content/Intent:CREATOR	Landroid/os/Parcelable$Creator;
      //   42: aload_3
      //   43: invokeinterface 71 2 0
      //   48: checkcast 61	android/content/Intent
      //   51: astore_1
      //   52: aload_3
