...
public class gu
{
  ...
  public static boolean a(Context paramContext)
  {
    ...
    if (i == 0)
    {
      gz.c("Please set theme of AdActivity to @android:style/Theme.Translucent to enable transparent background interstitial ad.");
      return false;
    }
    ...
    {
      gz.d("Fail to fetch AdActivity theme");
      gz.c("Please set theme of AdActivity to @android:style/Theme.Translucent to enable transparent background interstitial ad.");
    }
    return false;
  }
