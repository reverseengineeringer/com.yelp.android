...
public class eh
{
  ...
  {
    ta = new eh.a(this, paramContext, "google_inapp_purchase.db");
  }
  ...
  public void a(ef paramef)
  {
    ...
    localSQLiteDatabase.delete("InAppPurchase", String.format("%s = %d", new Object[] { "purchase_id", Long.valueOf(sT) }), null);
  }
  ...
  public void b(ef paramef)
  {
    ...
    localContentValues.put("product_id", sV);
    localContentValues.put("developer_payload", sU);
    localContentValues.put("record_time", Long.valueOf(SystemClock.elapsedRealtime()));
    sT = localSQLiteDatabase.insert("InAppPurchase", null, localContentValues);
  ...
  public void cA()
  {
    ...
    //   7: monitorenter
    //   8: aload_0
    //   9: invokevirtual 81	com/google/android/gms/internal/eh:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   12: astore_1
    //   13: aload_1
    //   14: ifnonnull +7 -> 21
    //   17: aload 4
    ...
    //   55: aload_0
    //   56: aload_2
    //   57: invokevirtual 151	com/google/android/gms/internal/eh:a	(Landroid/database/Cursor;)Lcom/google/android/gms/internal/ef;
    //   60: invokevirtual 153	com/google/android/gms/internal/eh:a	(Lcom/google/android/gms/internal/ef;)V
    //   63: aload_2
    //   64: ifnull +9 -> 73
    //   67: aload_2
    ...
    //   110: invokestatic 177	com/google/android/gms/internal/gr:W	(Ljava/lang/String;)V
    //   113: aload_2
    //   114: ifnull -41 -> 73
    //   117: aload_2
  ...
  public java.util.List<ef> d(long paramLong)
  {
    ...
    //   28: areturn
    //   29: aload_0
    //   30: invokevirtual 81	com/google/android/gms/internal/eh:getWritableDatabase	()Landroid/database/sqlite/SQLiteDatabase;
    //   33: astore 4
    //   35: aload 4
    //   37: ifnonnull +9 -> 46
    //   40: aload 7
    ...
    //   86: aload_0
    //   87: aload 5
    //   89: invokevirtual 151	com/google/android/gms/internal/eh:a	(Landroid/database/Cursor;)Lcom/google/android/gms/internal/ef;
    ...
    //   164: invokestatic 177	com/google/android/gms/internal/gr:W	(Ljava/lang/String;)V
    //   167: aload 5
    //   169: ifnull -43 -> 126
    //   172: aload 5
  ...
  public SQLiteDatabase getWritableDatabase()
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = ta.getWritableDatabase();
