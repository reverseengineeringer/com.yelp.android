...
public abstract interface ir
  extends IInterface
{
  public abstract void a(GetRecentContextCall.Request paramRequest, is paramis)
    throws RemoteException;
  
  public abstract void a(is paramis)
    throws RemoteException;
  
  public abstract void a(is paramis, String paramString1, String paramString2)
    throws RemoteException;
  
  public abstract void a(is paramis, String paramString, UsageInfo[] paramArrayOfUsageInfo)
    throws RemoteException;
  
  public abstract void a(is paramis, boolean paramBoolean)
    throws RemoteException;
  
  public abstract void b(is paramis)
    throws RemoteException;
    ...
    implements ir
  {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        a(is.a.a(paramParcel1.readStrongBinder()), paramParcel1.readString(), (UsageInfo[])paramParcel1.createTypedArray(UsageInfo.CREATOR));
        paramParcel2.writeNoException();
        return true;
      case 2: 
        paramParcel1.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
        a(is.a.a(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      case 3: 
        paramParcel1.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
        b(is.a.a(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      case 4: 
        paramParcel1.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
        localObject = is.a.a(paramParcel1.readStrongBinder());
        if (paramParcel1.readInt() != 0) {}
        for (boolean bool = true;; bool = false)
        {
          a((is)localObject, bool);
          paramParcel2.writeNoException();
          return true;
        }
      case 5: 
        ...
        {
          a((GetRecentContextCall.Request)localObject, is.a.a(paramParcel1.readStrongBinder()));
          paramParcel2.writeNoException();
          return true;
        }
      }
      paramParcel1.enforceInterface("com.google.android.gms.appdatasearch.internal.ILightweightAppDataSearch");
      a(is.a.a(paramParcel1.readStrongBinder()), paramParcel1.readString(), paramParcel1.readString());
      paramParcel2.writeNoException();
      return true;
    }
      ...
      implements ir
    {
      ...
      public void a(GetRecentContextCall.Request paramRequest, is paramis)
        throws RemoteException
      {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 17	com/google/android/gms/internal/ir$a$a:a	Landroid/os/IBinder;
        //   34: iconst_2
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
      ...
      /* Error */
      public void a(is paramis, String paramString1, String paramString2)
        throws RemoteException
      {
        // Byte code:
        //   0: invokestatic 27	android/os/Parcel:obtain	()Landroid/os/Parcel;
        ...
        //   28: aload 4
        //   30: aload_1
        //   31: invokevirtual 52	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
        //   34: aload 4
        //   36: aload_2
        ...
        //   46: aload_0
        //   47: getfield 17	com/google/android/gms/internal/ir$a$a:a	Landroid/os/IBinder;
        //   50: bipush 6
        //   52: aload 4
        //   54: aload 5
        //   56: iconst_0
      ...
      /* Error */
      public void a(is paramis, String paramString, UsageInfo[] paramArrayOfUsageInfo)
        throws RemoteException
      {
        // Byte code:
        //   0: invokestatic 27	android/os/Parcel:obtain	()Landroid/os/Parcel;
        ...
        //   47: aload_0
        //   48: getfield 17	com/google/android/gms/internal/ir$a$a:a	Landroid/os/IBinder;
        //   51: iconst_1
        //   52: aload 4
        //   54: aload 5
        //   56: iconst_0
      ...
      /* Error */
      public void a(is paramis, boolean paramBoolean)
        throws RemoteException
      {
        // Byte code:
        //   0: iconst_0
        ...
        //   48: aload_0
        //   49: getfield 17	com/google/android/gms/internal/ir$a$a:a	Landroid/os/IBinder;
        //   52: iconst_4
        //   53: aload 4
        //   55: aload 5
        //   57: iconst_0
