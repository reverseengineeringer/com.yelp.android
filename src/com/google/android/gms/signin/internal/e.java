  ...
  extends IInterface
{
  ...
  public abstract void a(ResolveAccountRequest paramResolveAccountRequest, zzt paramzzt)
    throws RemoteException;
  
  public abstract void a(zzp paramzzp, int paramInt, boolean paramBoolean)
    throws RemoteException;
    ...
    implements e
  {
      ...
      throws RemoteException
    {
      ...
      case 2: 
        ...
        a((AuthAccountRequest)localObject1, d.a.zzea(paramParcel1.readStrongBinder()));
      ...
      case 5: 
        ...
        a((ResolveAccountRequest)localObject1, zzt.zza.zzaT(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      case 7: 
        paramParcel1.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
      ...
      case 8: 
        ...
        a(paramInt1, (Account)localObject1, d.a.zzea(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      case 9: 
        paramParcel1.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
        ...
        a((zzp)localObject1, paramInt1, bool);
        paramParcel2.writeNoException();
        return true;
      case 10: 
        paramParcel1.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
        ...
        a((RecordConsentRequest)localObject1, d.a.zzea(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      case 11: 
        paramParcel1.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
        a(d.a.zzea(paramParcel1.readStrongBinder()));
        paramParcel2.writeNoException();
        return true;
      }
      paramParcel1.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
      ...
      a((SignInRequest)localObject1, d.a.zzea(paramParcel1.readStrongBinder()));
      paramParcel2.writeNoException();
      return true;
    }
      ...
      implements e
    {
      ...
      public void a(int paramInt, Account paramAccount, d paramd)
        throws RemoteException
      {
        Parcel localParcel1 = Parcel.obtain();
        Parcel localParcel2 = Parcel.obtain();
      ...
      public void a(AuthAccountRequest paramAuthAccountRequest, d paramd)
        throws RemoteException
      {
        Parcel localParcel1 = Parcel.obtain();
        Parcel localParcel2 = Parcel.obtain();
        for (;;)
        {
          try
          {
            ...
            if (paramAuthAccountRequest != null)
            {
              ...
              if (paramd != null)
              {
                paramAuthAccountRequest = paramd.asBinder();
      ...
      public void a(ResolveAccountRequest paramResolveAccountRequest, zzt paramzzt)
        throws RemoteException
      {
        Parcel localParcel1 = Parcel.obtain();
        Parcel localParcel2 = Parcel.obtain();
      ...
      /* Error */
      public void a(zzp paramzzp, int paramInt, boolean paramBoolean)
        throws RemoteException
      {
        // Byte code:
        //   0: iconst_0
        ...
        //   58: aload_0
        //   59: getfield 17	com/google/android/gms/signin/internal/e$a$a:a	Landroid/os/IBinder;
        //   62: bipush 9
        //   64: aload 5
        //   66: aload 6
        //   68: iconst_0
        //   69: invokeinterface 42 5 0
        //   74: pop
        //   75: aload 6
        //   77: invokevirtual 45	android/os/Parcel:readException	()V
        //   80: aload 6
        ...
        throws RemoteException
      {
        ...
        //   29: aload_0
        //   30: getfield 17	com/google/android/gms/signin/internal/e$a$a:a	Landroid/os/IBinder;
        //   33: iconst_3
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
      ...
      public void a(RecordConsentRequest paramRecordConsentRequest, d paramd)
        throws RemoteException
      {
        Parcel localParcel1 = Parcel.obtain();
        Parcel localParcel2 = Parcel.obtain();
        for (;;)
        {
          try
          {
            ...
            if (paramRecordConsentRequest != null)
            {
              ...
              if (paramd != null)
              {
                paramRecordConsentRequest = paramd.asBinder();
      ...
      public void a(SignInRequest paramSignInRequest, d paramd)
        throws RemoteException
      {
        Parcel localParcel1 = Parcel.obtain();
        Parcel localParcel2 = Parcel.obtain();
        for (;;)
        {
          try
          {
            ...
            if (paramSignInRequest != null)
            {
              ...
              if (paramd != null)
              {
                paramSignInRequest = paramd.asBinder();
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 17	com/google/android/gms/signin/internal/e$a$a:a	Landroid/os/IBinder;
        //   34: bipush 11
        //   36: aload_2
        //   37: aload_3
        //   38: iconst_0
