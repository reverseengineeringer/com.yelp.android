  ...
  implements Parcelable.Creator<RecordConsentRequest>
{
  static void a(RecordConsentRequest paramRecordConsentRequest, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 2, paramRecordConsentRequest.a(), paramInt, false);
    zzb.zza(paramParcel, 3, paramRecordConsentRequest.b(), paramInt, false);
    zzb.zza(paramParcel, 4, paramRecordConsentRequest.c(), false);
