  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    catch (IllegalStateException localIllegalStateException)
    {
      ...
      Log.e(VideoDisplayComponent.access$1200(), "Media player position sampled when it was in an invalid state: " + localIllegalStateException.getMessage(), localIllegalStateException);
    ...
    {
      this$0.destroyPlayer();
      Log.e(VideoDisplayComponent.access$1200(), "Error monitoring playback progress" + localException.getMessage(), localException);
