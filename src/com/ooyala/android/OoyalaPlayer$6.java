...
class OoyalaPlayer$6
  implements AuthorizeCallback
{
  OoyalaPlayer$6(OoyalaPlayer paramOoyalaPlayer, String paramString) {}
  ...
  public void callback(boolean paramBoolean, OoyalaException paramOoyalaException)
  {
    ...
    if (paramOoyalaException != null)
    {
      ...
      Log.d(OoyalaPlayer.access$200(), "Exception in reinitialize!", paramOoyalaException);
      OoyalaPlayer.access$300(this$0, OoyalaPlayer.State.ERROR);
      OoyalaPlayer.access$400(this$0, "error");
      return;
    }
    this$0.changeCurrentItem(OoyalaPlayer.access$800(this$0).firstVideo());
  }
}

/* Location:
 * Qualified Name:     com.ooyala.android.OoyalaPlayer.6
