...
class Channel$NextChildrenRunner
  implements Runnable
{
  private PaginatedItemListener _listener = null;
  
  public Channel$NextChildrenRunner(Channel paramChannel, PaginatedItemListener paramPaginatedItemListener)
  {
  ...
  public void run()
  {
    ...
    List localList = ContentItem.getEmbedCodes(this$0._videos.subList(firstIndex, firstIndex + count));
    try
    {
...
/* Location:
 * Qualified Name:     com.ooyala.android.Channel.NextChildrenRunner
