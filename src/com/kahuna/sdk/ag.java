...
public class ag
{
  protected static a a(Context paramContext, boolean paramBoolean)
  {
    ...
    if (i < j)
    {
      ...
      break label256;
      if (h.a) {
        Log.d("KahunaAnalytics", "Exception getting saved events: " + localException1);
      }
  ...
  {
    return m(paramContext).getString("device_id", "");
  }
  ...
  protected static Map<String, ? extends Object> a(Context paramContext, String paramString, Class<?> paramClass)
  {
    ...
    //   10: astore 7
    //   12: aload_0
    //   13: invokestatic 12	com/kahuna/sdk/ag:m	(Landroid/content/Context;)Landroid/content/SharedPreferences;
    //   16: astore 8
    //   18: aload 8
    //   20: aload_1
    //   21: aconst_null
    ...
    //   27: astore_0
    //   28: aload_0
    //   29: invokestatic 31	com/kahuna/sdk/aj:a	(Ljava/lang/String;)Z
    //   32: ifne +250 -> 282
    ...
    //   128: goto -50 -> 78
    //   131: astore_0
    //   132: getstatic 68	com/kahuna/sdk/h:a	Z
    //   135: ifeq +28 -> 163
    //   138: ldc 70
  ...
  public static Map<String, Long> a(h paramh, Context paramContext)
  {
    if (paramh != null) {}
    try
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (!aj.a((String)localObject))
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              paramh.put(str, Long.valueOf(((JSONObject)localObject).getLong(str)));
            }
          }
        }
        ...
        {
          if (h.a) {
            Log.d("KahunaAnalytics", "Exception getting saved region Ids: " + paramh);
          }
          paramh = new HashMap();
  ...
  {
    m(paramContext).edit().putLong("last_flush_timestamp", paramLong).commit();
  }
  ...
  protected static void a(Context paramContext, JSONObject paramJSONObject)
  {
    ...
    Log.d("KahunaAnalytics", "Exception saving SDK configuration: " + paramContext);
  }
  
  /* Error */
  public static void a(h paramh, Context paramContext, String paramString)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   25: return
    //   26: aload_1
    //   27: invokestatic 12	com/kahuna/sdk/ag:m	(Landroid/content/Context;)Landroid/content/SharedPreferences;
  ...
  public static void a(h paramh, Context paramContext, JSONArray paramJSONArray)
  {
    ...
    {
      return;
      paramh = m(paramContext);
      try
      {
        paramh.edit().putString("tracked_ibeacons", paramJSONArray.toString()).commit();
        return;
      }
      catch (Exception paramh) {}
    } while (!h.a);
    Log.d("KahunaAnalytics", "Exception saving tracked iBeacons: " + paramh);
  }
  ...
  public static void a(h paramh, List<d> paramList, Context paramContext)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramList == null)
        {
          paramh.edit().putString("geofencing_objects_list", null).commit();
          continue;
        }
        try
        {
      ...
      Log.d("KahunaAnalytics", "Exception saving geofences: " + paramh);
      continue;
      paramh.edit().putString("geofencing_objects_list", paramContext.toString()).commit();
    }
  }
  
  public static void a(h paramh, Map<String, Long> paramMap, Context paramContext)
  {
    if (paramh != null) {}
    for (;;)
    {
      try
      {
        ...
        if (paramMap == null)
        {
          paramh.edit().putString("geofencing_regions", null).commit();
          continue;
        }
        try
        {
      ...
      Log.d("KahunaAnalytics", "Exception saving region Ids: " + paramh);
      continue;
      paramh.edit().putString("geofencing_regions", paramContext.toString()).commit();
    }
  }
  
  protected static void a(String paramString, Context paramContext)
  {
    m(paramContext).edit().putString("device_id", paramString).commit();
  }
  ...
  protected static void a(List<Event> paramList, Context paramContext)
  {
    for (;;)
    {
      ...
      try
      {
        ...
        if (i < k)
        {
          JSONObject localJSONObject = ((Event)paramList.get(i)).h();
        ...
        else
        {
          ...
          Log.d("KahunaAnalytics", "Exception saving events: " + paramList);
          continue;
          continue;
        }
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          ...
          if (((localObject instanceof String)) && (aj.a((String)localObject)))
          {
            if (!h.a) {
              continue;
            }
        ...
        {
          if (h.a) {
            Log.d("KahunaAnalytics", "Exception saving user map: " + paramMap);
          }
          paramContext.edit().putString(paramString, null).commit();
        }
  ...
  protected static void a(Set<String> paramSet, Context paramContext)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Log.d("KahunaAnalytics", "Exception saving dirty user attributes: " + paramSet);
        continue;
  ...
  protected static void a(JSONObject paramJSONObject, Context paramContext)
  {
    ...
    try
    {
      m(paramContext).edit().putString("debug_manager_storage_object", paramJSONObject.toString()).commit();
      return;
    }
    finally
    {
  ...
  {
    m(paramContext).edit().putBoolean("push_enabled", paramBoolean).commit();
  }
  
  /* Error */
  public static List<d> b(h paramh, Context paramContext)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    ...
    //   42: astore_3
    //   43: aload_1
    //   44: invokestatic 12	com/kahuna/sdk/ag:m	(Landroid/content/Context;)Landroid/content/SharedPreferences;
    //   47: astore_1
    //   48: aload_1
    //   49: ldc -30
    //   51: aconst_null
    ...
    //   60: astore_0
    //   61: aload 4
    //   63: invokestatic 31	com/kahuna/sdk/aj:a	(Ljava/lang/String;)Z
    //   66: ifne -36 -> 30
    ...
    //   119: goto -37 -> 82
    //   122: astore_0
    //   123: getstatic 68	com/kahuna/sdk/h:a	Z
    //   126: ifeq +29 -> 155
    //   129: ldc 70
  ...
  private static Map<String, ? extends Object> b(Context paramContext, String paramString, Class<?> paramClass)
  {
    for (;;)
    {
      try
      {
        ...
        {
          if (h.a) {
            Log.d("KahunaAnalytics", "Exception getting stored internal map: " + paramContext);
          }
  ...
  {
    m(paramContext).edit().putString("prev_push_token", paramString).commit();
  }
  
  protected static void b(Map<String, String> paramMap, Context paramContext)
  {
    a(paramMap, paramContext, "user_attributes");
  }
  
  protected static void b(boolean paramBoolean, Context paramContext)
  {
    m(paramContext).edit().putBoolean("insert_credentials", paramBoolean).commit();
  }
  
  protected static boolean b(Context paramContext)
  {
    return m(paramContext).getBoolean("push_enabled", true);
  }
  
  protected static String c(Context paramContext)
  {
    return m(paramContext).getString("prev_push_token", "");
  }
  
  /* Error */
  public static String c(h paramh, Context paramContext)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   30: areturn
    //   31: aload_1
    //   32: invokestatic 12	com/kahuna/sdk/ag:m	(Landroid/content/Context;)Landroid/content/SharedPreferences;
    //   35: ldc -39
    //   37: aconst_null
  ...
  {
    m(paramContext).edit().putString("prev_sdk_version", paramString).commit();
  }
  
  protected static void c(Map<String, Long> paramMap, Context paramContext)
  {
    try
    {
  ...
  protected static boolean d(Context paramContext)
  {
    return m(paramContext).getBoolean("insert_credentials", false);
  }
  ...
  protected static Map<String, String> f(Context paramContext)
  {
    return b(paramContext, "user_attributes", String.class);
  }
  
  /* Error */
  protected static Set<String> g(Context paramContext)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: new 342	java/util/HashSet
    //   6: dup
    //   7: invokespecial 343	java/util/HashSet:<init>	()V
    //   10: astore_3
    //   11: aload_0
    //   12: invokestatic 12	com/kahuna/sdk/ag:m	(Landroid/content/Context;)Landroid/content/SharedPreferences;
    //   15: astore 4
    //   17: aload 4
    //   19: ldc_w 296
    //   22: aconst_null
    ...
    //   31: astore_0
    //   32: aload 5
    //   34: invokestatic 31	com/kahuna/sdk/aj:a	(Ljava/lang/String;)Z
    //   37: ifne +107 -> 144
    ...
    //   67: aload 5
    //   69: iload_1
    //   70: invokevirtual 346	org/json/JSONArray:optString	(I)Ljava/lang/String;
    //   73: invokeinterface 347 2 0
    //   78: pop
    //   79: iload_1
    //   80: iconst_1
    //   81: iadd
    ...
    //   83: goto -24 -> 59
    //   86: astore_0
    //   87: getstatic 68	com/kahuna/sdk/h:a	Z
    //   90: ifeq +29 -> 119
    //   93: ldc 70
    ...
    //   118: pop
    //   119: new 342	java/util/HashSet
    //   122: dup
    //   123: invokespecial 343	java/util/HashSet:<init>	()V
    //   126: astore_0
    //   127: aload 4
    ...
    //   58	25	1	i	int
    //   56	8	2	j	int
    //   10	57	3	localHashSet	java.util.HashSet
  ...
  protected static long h(Context paramContext)
  {
    return m(paramContext).getLong("last_flush_timestamp", 0L);
  }
  ...
  protected static JSONObject i(Context paramContext)
  {
    ...
    catch (Exception paramContext)
    {
      ...
      {
        if (h.a) {
          Log.d("KahunaAnalytics", "Exception getting SDK configuration: " + paramContext);
        }
        paramContext = null;
      }
    }
  ...
  {
    return m(paramContext).getString("prev_sdk_version", "0");
  }
  
  protected static Map<String, Long> k(Context paramContext)
  {
    try
    {
  ...
  /* Error */
  protected static JSONObject l(Context paramContext)
  {
    // Byte code:
    //   0: ldc 2
    //   2: monitorenter
    //   3: aload_0
    //   4: invokestatic 12	com/kahuna/sdk/ag:m	(Landroid/content/Context;)Landroid/content/SharedPreferences;
    //   7: astore_0
    ...
    //   32: areturn
    //   33: astore_0
    //   34: getstatic 68	com/kahuna/sdk/h:a	Z
    //   37: ifeq +29 -> 66
    //   40: ldc 70
...
/* Location:
 * Qualified Name:     com.kahuna.sdk.ag
