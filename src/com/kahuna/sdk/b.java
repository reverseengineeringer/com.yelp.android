...
public class b
{
  ...
  {
    if ((paramEvent == null) || (aj.a(paramEvent.a()))) {}
    String str;
    do
    {
      return;
    ...
    for (;;)
    {
      synchronized (ad)
      {
        if (!ae.containsKey(str))
        {
          ...
          if (h.a) {
            Log.d("KahunaAnalytics", "Inserted new bucket mapping '" + str + "'");
          }
          return;
        }
      }
      if (h.a) {
        Log.d("KahunaAnalytics", "Attempted to insert bucket mapping that already exists '" + str + "', aborting.");
      }
    }
  }
  ...
  {
    // Byte code:
    //   0: getstatic 21	com/kahuna/sdk/b:a	Lcom/kahuna/sdk/b;
    //   3: getfield 32	com/kahuna/sdk/b:d	Ljava/lang/Object;
    //   6: astore_3
    //   7: aload_3
    //   8: monitorenter
    //   9: getstatic 21	com/kahuna/sdk/b:a	Lcom/kahuna/sdk/b;
    //   12: getfield 25	com/kahuna/sdk/b:b	Ljava/lang/Object;
    //   15: astore 4
    //   17: aload 4
    //   19: monitorenter
    //   20: getstatic 21	com/kahuna/sdk/b:a	Lcom/kahuna/sdk/b;
    //   23: getfield 34	com/kahuna/sdk/b:e	Ljava/util/HashMap;
    ...
    //   63: astore 6
    //   65: aload 5
    //   67: invokevirtual 132	com/kahuna/sdk/Event:f	()Z
    //   70: ifeq +187 -> 257
    //   73: getstatic 21	com/kahuna/sdk/b:a	Lcom/kahuna/sdk/b;
    //   76: getfield 30	com/kahuna/sdk/b:c	Ljava/util/HashMap;
    //   79: aload 6
    ...
    //   90: ldc2_w 138
    //   93: ldiv
    //   94: getstatic 21	com/kahuna/sdk/b:a	Lcom/kahuna/sdk/b;
    //   97: getfield 30	com/kahuna/sdk/b:c	Ljava/util/HashMap;
    //   100: aload 6
    ...
    //   117: lcmp
    //   118: ifge +139 -> 257
    //   121: getstatic 21	com/kahuna/sdk/b:a	Lcom/kahuna/sdk/b;
    //   124: aload 5
    //   126: invokevirtual 75	com/kahuna/sdk/Event:a	()Ljava/lang/String;
    //   129: aload 5
    //   131: invokevirtual 77	com/kahuna/sdk/Event:b	()J
    //   134: invokespecial 43	com/kahuna/sdk/b:b	(Ljava/lang/String;J)Ljava/lang/String;
    //   137: astore 6
    //   139: getstatic 21	com/kahuna/sdk/b:a	Lcom/kahuna/sdk/b;
    //   142: getfield 34	com/kahuna/sdk/b:e	Ljava/util/HashMap;
    //   145: aload 6
    //   147: invokevirtual 47	java/util/HashMap:containsKey	(Ljava/lang/Object;)Z
    //   150: ifne +107 -> 257
    //   153: getstatic 21	com/kahuna/sdk/b:a	Lcom/kahuna/sdk/b;
    //   156: getfield 34	com/kahuna/sdk/b:e	Ljava/util/HashMap;
    //   159: aload 6
    //   161: aload 5
    //   163: invokevirtual 81	java/util/HashMap:put	(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    //   166: pop
    //   167: getstatic 86	com/kahuna/sdk/h:a	Z
    //   170: ifeq +87 -> 257
    //   173: ldc 88
    ...
    //   223: athrow
    //   224: astore_0
    //   225: getstatic 86	com/kahuna/sdk/h:a	Z
    //   228: ifeq -16 -> 212
    //   231: ldc 88
  ...
  protected static void a(JSONObject paramJSONObject)
  {
    ...
    {
      if (h.a) {
        Log.w("KahunaAnalytics", "Caught exception loading bucket mappings from persistent store: " + paramJSONObject);
      }
      return;
    }
  }
  ...
  private String b(String paramString, long paramLong)
  {
    ...
    synchronized (c)
    {
      ...
      Log.w("KahunaAnalytics", "Attempted to obtain a bucket mapping for event not in bucketConfig: " + str);
      paramString = (String)localObject;
    }
  }
}
...
/* Location:
 * Qualified Name:     com.kahuna.sdk.b
