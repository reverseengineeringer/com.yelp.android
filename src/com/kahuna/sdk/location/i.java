...
public class i
{
  ...
  protected i(String paramString1, String paramString2, int paramInt1, int paramInt2, long paramLong)
  {
    a = paramString1;
    b = paramString2;
    if (b != null) {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((b == null) || (!b.equalsIgnoreCase(((i)paramObject).b())));
    if ((c < 0) || (((i)paramObject).c() < 0)) {}
    for (int k = 1;; k = 0)
    {
      if ((d < 0) || (((i)paramObject).d() < 0)) {}
      for (int m = 1;; m = 0)
      {
        if ((k != 0) && (m != 0)) {
          return true;
        }
        if ((c != ((i)paramObject).c()) || (d != ((i)paramObject).d())) {
          break;
        }
        return true;
      }
