  ...
  implements SensorEventListener
{
  ...
  public q(ActivityMonocle paramActivityMonocle, SensorManager paramSensorManager)
  {
  ...
  {
    if (n.b(4)) {}
    for (int i = new s(null).a();; i = new t(null).a())
    {
...
/* Location:
 * Qualified Name:     com.yelp.android.ui.q
