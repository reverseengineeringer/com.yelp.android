  ...
  extends w<IdentifiableMedia>
{
  ...
  public a(Context paramContext, a.b paramb, View.OnClickListener paramOnClickListener, Pair<EventIri, Map<String, Object>> paramPair)
  {
    i = t.a(paramContext);
    f = paramb;
    ...
    g = new a.1(this, (EventIri)first, (Map)second);
    h = false;
  }
  
  public static a a(Context paramContext, View.OnClickListener paramOnClickListener, EventIri paramEventIri, Map<String, Object> paramMap, String paramString)
  {
    return new a(paramContext, new a.b(paramEventIri, paramMap, paramString, null), paramOnClickListener, Pair.create(paramEventIri, paramMap));
  }
  ...
  private String a(Media paramMedia, PhotoConfig.Size paramSize)
  {
    ...
    if (paramMedia.a(Media.MediaType.PHOTO)) {
      paramSize = ((Photo)paramMedia).a(paramSize, PhotoConfig.Aspect.Square);
    }
    do
    {
      return paramSize;
      paramSize = (PhotoConfig.Size)localObject;
    } while (!paramMedia.a(Media.MediaType.VIDEO));
    return ((Video)paramMedia).f();
  }
  
  private void a(Media paramMedia, View paramView1, View paramView2)
  {
    paramView2 = paramView2.findViewById(2131690967);
    if (paramMedia.a(Media.MediaType.PHOTO)) {
      if (paramView2 != null) {
    ...
    return;
    paramMedia = paramView1.findViewById(2131690753);
  ...
  {
    if ((paramMedia.a(Media.MediaType.PHOTO)) || (paramMedia.a(Media.MediaType.VIDEO)))
    {
  ...
  private void a(Media paramMedia, PhotoConfig.Size paramSize, ImageView paramImageView)
  {
    ...
    i.a(a(paramMedia, paramSize)).a(width, height).a(paramImageView);
  }
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramViewGroup = new a.a(2);
      paramViewGroup.a(paramView, new int[] { 2131690750, 2131690752 });
    ...
    for (;;)
    {
      ...
      a(paramInt, paramView, paramView.findViewById(2131690750), a[0], b[0], PhotoConfig.Size.Px_120);
      a(paramInt + 1, paramView, paramView.findViewById(2131690752), a[1], b[1], PhotoConfig.Size.Px_120);
      return paramView;
    }
  }
  ...
  public void a(int paramInt, View paramView1, View paramView2, WebImageView paramWebImageView, TextView paramTextView, PhotoConfig.Size paramSize)
  {
    ...
    paramWebImageView.setTag(2131689519, Integer.valueOf(paramInt));
    paramWebImageView.setTag(2131689520, a());
  }
  ...
  {
    int m = as.a(a(), paramIdentifiableMedia);
    if (m >= 0)
    {
