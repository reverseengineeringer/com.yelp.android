  ...
  extends au<Object>
{
  ...
  private final v d;
  private final YelpBusiness e;
  
  public t(int paramInt, v paramv, YelpBusiness paramYelpBusiness)
  {
    b = paramInt;
    c = null;
    d = paramv;
  ...
  {
    SpannableString localSpannableString = SpannableString.valueOf(StringUtils.a(paramContext, 2131165913, new Object[0]));
    ...
    while (i < j)
    {
      ...
      if (localStyleSpan.getStyle() == 1) {
        localSpannableString.setSpan(new ForegroundColorSpan(paramContext.getResources().getColor(2131361919)), localSpannableString.getSpanStart(localStyleSpan), localSpannableString.getSpanEnd(localStyleSpan), 33);
      }
      i += 1;
    }
    return TextUtils.expandTemplate(localSpannableString, new CharSequence[] { Html.fromHtml(paramYelpBusinessReviewInsight.getText()) });
  }
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      localObject1 = localReviewHighlight.getMarkedUpSentence(paramViewGroup.getContext());
    ...
    paramView = a(paramInt, paramView, paramViewGroup, (CharSequence)localObject2, localReviewHighlight.getTitle(), localReviewHighlight.getPhotoUrl());
    paramView.setOnClickListener(new u(this, localReviewHighlight));
    return paramView;
  }
  ...
  public View a(int paramInt, View paramView, ViewGroup paramViewGroup, CharSequence paramCharSequence1, CharSequence paramCharSequence2, String paramString)
  {
    ...
    if (paramView == null)
    {
      ...
      localView.setTag(new w(localView));
    }
    ...
    for (;;)
    {
      d.setImageUrl(paramString, 2130837659);
  ...
  public View b(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (CharSequence localCharSequence1 = (CharSequence)c.get(paramInt);; localCharSequence1 = null)
    {
      ...
      return a(paramInt, paramView, paramViewGroup, localCharSequence2, null, localYelpBusinessReviewInsight.getImageUrl());
    }
  }
  ...
  public View c(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    View localView = paramView;
    if (paramView == null) {
      localView = LayoutInflater.from(localContext).inflate(2130903325, paramViewGroup, false);
    }
    return localView;
  }
...
/* Location:
 * Qualified Name:     com.yelp.android.ui.activities.reviewpage.t
