  ...
  implements ListAdapter, j
{
  ...
  public s(au<Type> paramau, int paramInt1, int paramInt2, int paramInt3)
  {
    a = paramau;
    c = paramInt2;
    d = paramInt3;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((a(paramInt)) || (b(paramInt)))
    {
      ...
      paramView.setLayoutParams(new AbsListView.LayoutParams(cp.a()));
...
/* Location:
 * Qualified Name:     com.yelp.android.ui.activities.profile.s
