...
class bd
  implements m<YelpBusiness>
{
  private final PurchaseDealsForm b;
  
  public bd(PurchaseDealsForm paramPurchaseDealsForm1, PurchaseDealsForm paramPurchaseDealsForm2)
  {
  ...
  public void a(ApiRequest<?, ?, ?> paramApiRequest, YelpBusiness paramYelpBusiness)
  {
    ...
    paramApiRequest.put("deal_id", PurchaseDealsForm.c(b).getId());
    paramApiRequest.put("deal_option_id", PurchaseDealsForm.g(b).getId());
...
/* Location:
 * Qualified Name:     com.yelp.android.ui.activities.deals.bd
