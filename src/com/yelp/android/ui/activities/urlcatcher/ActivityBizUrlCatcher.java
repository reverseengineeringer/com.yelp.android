  ...
  extends YelpUrlCatcherActivity
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    try
    {
      ae.a(getIntent()).a("android.intent.action.VIEW", "http", "/biz/").a("android.intent.action.VIEW", "yelp", "/biz/").a("android.intent.action.VIEW", "yelp4", "/biz/").a(new String[] { "biz" }).a();
      paramBundle = getIntent().getData();
      Intent localIntent = a.a(this, paramBundle, getIntent().getExtras());
      if (localIntent != null)
      {
...
/* Location:
 * Qualified Name:     com.yelp.android.ui.activities.urlcatcher.ActivityBizUrlCatcher
