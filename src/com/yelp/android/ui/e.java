  ...
  extends View
{
  ...
  public e(Context paramContext, String[] paramArrayOfString, Runnable[] paramArrayOfRunnable)
  {
    super(paramContext);
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if (paramMotionEvent.getAction() == 0)
    {
      ...
      label62:
      int i3;
      if (paramMotionEvent.getX() > l - (84.0F * f1 - 10.0F * f1))
      {
        i1 = 1;
        if (paramMotionEvent.getX() >= l - f1 * 10.0F) {
          break label212;
        }
        i2 = 1;
        if (paramMotionEvent.getY() <= 10.0F) {
          break label218;
        }
        i3 = 1;
        label75:
        if (paramMotionEvent.getY() >= k - 10.0F) {
          break label224;
        }
      }
      label212:
      ...
      for (int i4 = 1;; i4 = 0)
      {
        ...
        i1 = (int)((paramMotionEvent.getY() - 10.0F - (paramMotionEvent.getY() - 10.0F) % (q / r)) / (q / r));
        if (p != i1)
        {
          p = i1;
          o = (q * p / r);
