...
public class s
{
  private final AsyncTask<Pair<Bitmap, ImageView>, Void, Pair<Bitmap, ImageView>> a = new AsyncTask()
  {
    protected Pair<Bitmap, ImageView> a(Pair<Bitmap, ImageView>... paramAnonymousVarArgs)
    {
      Bitmap localBitmap = (Bitmap)0first;
      paramAnonymousVarArgs = (ImageView)0second;
      if (localBitmap != null) {
        return new Pair(s.a(s.this, localBitmap, 4), paramAnonymousVarArgs);
      }
      return null;
    }
    
    protected void a(Pair<Bitmap, ImageView> paramAnonymousPair)
    {
      if (paramAnonymousPair != null)
      {
        Bitmap localBitmap = (Bitmap)first;
        paramAnonymousPair = (ImageView)second;
        paramAnonymousPair.setImageBitmap(localBitmap);
        av.c(paramAnonymousPair, av.c);
      }
    }
  };
  ...
  public void b(Bitmap paramBitmap, ImageView paramImageView)
  {
    ...
    if (paramBitmap != null) {
      localBitmap = Bitmap.createScaledBitmap(paramBitmap, (int)paramImageView.getContext().getResources().getDimension(a.d.blur_image_width), (int)paramImageView.getContext().getResources().getDimension(a.d.blur_image_height), false);
    }
