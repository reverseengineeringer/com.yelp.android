...
{
  dc(ViewTreeObserver paramViewTreeObserver, ListView paramListView, View paramView, au paramau, HashMap paramHashMap, Runnable paramRunnable) {}
  ...
  public boolean onPreDraw()
  {
    ...
    while (i < b.getChildCount())
    {
      ...
      if (localInteger != null)
      {
        if (localInteger.intValue() != m)
        {
          ...
          localView.animate().setDuration(cw.d).translationY(0.0F);
        }
        i += 1;
      }
      else
    ...
    if (f != null) {
      new Handler().postDelayed(f, cw.d);
    }
    return true;
  }
}
...
/* Location:
 * Qualified Name:     com.yelp.android.ui.util.dc
