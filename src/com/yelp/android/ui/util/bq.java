  ...
  extends bm
{
  ...
  public bq(ScrollToLoadListView paramScrollToLoadListView1, ScrollToLoadListView paramScrollToLoadListView2)
  {
  ...
  private void a(AbsListView paramAbsListView, int paramInt)
  {
    ...
    if ((paramAbsListView instanceof bo)) {
      ((bo)paramAbsListView).a();
    }
  }
...
/* Location:
 * Qualified Name:     com.yelp.android.ui.util.bq
