  ...
  implements View.OnTouchListener
{
  ...
  protected bh(View paramView1, View paramView2)
  {
    o = paramView1;
    p = paramView2;
    ...
    for (;;)
    {
      ...
      if (!j)
      {
        ...
        else
        {
          ...
          i = 1;
          f1 = Math.abs(f3);
          if ((Double.isNaN(l)) || (i != n) || (Math.abs(f2 - l) <= ao.a(3))) {
            break label285;
          }
          a = ((float)l);
          l = NaN.0D;
...
/* Location:
 * Qualified Name:     com.yelp.android.ui.util.bh
