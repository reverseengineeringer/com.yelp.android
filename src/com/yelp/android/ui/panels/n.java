...
{
  n(BizAttributesFragment paramBizAttributesFragment) {}
  ...
  public void onGlobalLayout()
  {
    ...
    for (;;)
    {
      if (!TextUtils.isEmpty((CharSequence)localObject1))
      {
        ...
        d.a(new BizAttributesFragment.AttributeVotingStringException(a, (String)localObject1));
      }
      i += 1;
      break;
      if ((localView instanceof TwoTierButton))
      {
        ...
        if (a((TextView)localObject3, (String)localObject2))
        {
          localObject1 = localObject2;
          continue;
          cp.a(BizAttributesFragment.f(a), this);
          return;
          label222:
          localObject1 = null;
        }
...
/* Location:
 * Qualified Name:     com.yelp.android.ui.panels.n
