...
public class a
{
    ...
    throws IOException
  {
    ...
    //   5: aload_0
    //   6: ifnonnull +13 -> 19
    //   9: new 179	java/lang/NullPointerException
    //   12: dup
    //   13: ldc -18
    //   15: invokespecial 184	java/lang/NullPointerException:<init>	(Ljava/lang/String;)V
    //   18: athrow
    //   19: aload_0
    //   20: ldc -32
    //   22: invokevirtual 241	java/lang/String:getBytes	(Ljava/lang/String;)[B
    //   25: astore_2
    //   26: aload_2
    //   27: astore_0
    //   28: aload_0
    //   29: aload_0
    //   30: arraylength
    //   31: invokestatic 244	com/yelp/android/cy/a:b	([BI)[B
    //   34: astore 6
    //   36: aload 6
    //   38: ifnull +118 -> 156
    //   41: aload 6
    ...
    //   77: astore 7
    //   79: new 248	java/io/ByteArrayOutputStream
    //   82: dup
    //   83: invokespecial 249	java/io/ByteArrayOutputStream:<init>	()V
    //   86: astore 4
    //   88: new 251	java/io/ByteArrayInputStream
    //   91: dup
    //   92: aload 6
    //   94: invokespecial 252	java/io/ByteArrayInputStream:<init>	([B)V
    //   97: astore_2
    //   98: new 254	java/util/zip/GZIPInputStream
    //   101: dup
    //   102: aload_2
    //   103: invokespecial 257	java/util/zip/GZIPInputStream:<init>	(Ljava/io/InputStream;)V
    //   106: astore_0
    //   107: aload_0
    //   108: aload 7
    //   110: invokevirtual 261	java/util/zip/GZIPInputStream:read	([B)I
    //   113: istore_1
    //   114: iload_1
    //   115: iflt +53 -> 168
    //   118: aload 4
    ...
    //   122: iconst_0
    //   123: iload_1
    //   124: invokevirtual 265	java/io/ByteArrayOutputStream:write	([BII)V
    //   127: goto -20 -> 107
    //   130: astore 5
    //   132: aload_0
    //   133: astore_3
    ...
    //   138: astore_2
    //   139: aload_2
    //   140: invokevirtual 268	java/io/IOException:printStackTrace	()V
    //   143: aload 4
    //   145: invokevirtual 271	java/io/ByteArrayOutputStream:close	()V
    //   148: aload_3
    //   149: invokevirtual 272	java/util/zip/GZIPInputStream:close	()V
    //   152: aload_0
    //   153: invokevirtual 273	java/io/ByteArrayInputStream:close	()V
    //   156: aload 6
    //   158: areturn
    //   159: astore_2
    //   160: aload_0
    //   161: invokevirtual 276	java/lang/String:getBytes	()[B
    //   164: astore_0
    //   165: goto -137 -> 28
    //   168: aload 4
    //   170: invokevirtual 279	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   173: astore_3
    //   174: aload 4
    //   176: invokevirtual 271	java/io/ByteArrayOutputStream:close	()V
    //   179: aload_0
    //   180: invokevirtual 272	java/util/zip/GZIPInputStream:close	()V
    //   183: aload_2
    //   184: invokevirtual 273	java/io/ByteArrayInputStream:close	()V
    //   187: aload_3
    //   188: areturn
    //   189: astore_0
    //   190: aload_3
    ...
    //   200: astore_3
    //   201: aload 4
    //   203: invokevirtual 271	java/io/ByteArrayOutputStream:close	()V
    //   206: aload_3
    //   207: invokevirtual 272	java/util/zip/GZIPInputStream:close	()V
    //   210: aload_2
    //   211: invokevirtual 273	java/io/ByteArrayInputStream:close	()V
    //   214: aload_0
    //   215: athrow
    //   216: astore 4
    //   218: goto -39 -> 179
    ...
    //   113	11	1	i	int
    //   25	115	2	localObject1	Object
    //   159	25	2	localUnsupportedEncodingException	UnsupportedEncodingException
    //   197	14	2	localObject2	Object
    //   225	1	2	localException1	Exception
    //   229	1	2	localException2	Exception
    //   246	1	2	localException3	Exception
    //   252	28	2	str	String
    //   286	1	2	localIOException1	IOException
    //   295	9	2	localIOException2	IOException
    //   307	1	2	localIOException3	IOException
    //   4	203	3	localObject3	Object
    //   242	1	3	localException4	Exception
    //   255	15	3	localObject4	Object
    //   86	116	4	localByteArrayOutputStream	java.io.ByteArrayOutputStream
    //   216	1	4	localException5	Exception
    //   237	1	4	localException6	Exception
    //   288	1	4	localObject5	Object
    //   1	1	5	localObject6	Object
    //   130	131	5	localIOException4	IOException
    //   266	5	5	localObject7	Object
    //   276	5	5	localObject8	Object
    //   301	5	5	localIOException5	IOException
    //   34	201	6	arrayOfByte1	byte[]
    //   77	44	7	arrayOfByte2	byte[]
    // Exception table:
    //   from	to	target	type
    //   107	114	130	java/io/IOException
    //   118	127	130	java/io/IOException
    //   168	174	130	java/io/IOException
    //   19	26	159	java/io/UnsupportedEncodingException
    //   183	187	189	java/lang/Exception
    //   79	88	192	finally
    //   174	179	216	java/lang/Exception
    //   179	183	221	java/lang/Exception
    //   143	148	225	java/lang/Exception
    //   148	152	229	java/lang/Exception
    //   152	156	233	java/lang/Exception
    //   201	206	237	java/lang/Exception
    //   206	210	242	java/lang/Exception
    //   210	214	246	java/lang/Exception
    //   88	98	250	finally
    //   98	107	259	finally
    //   107	114	266	finally
    //   118	127	266	finally
    //   168	174	266	finally
    //   139	143	276	finally
    //   79	88	286	java/io/IOException
    //   88	98	295	java/io/IOException
    //   98	107	301	java/io/IOException
  }
...
/* Location:
 * Qualified Name:     com.yelp.android.cy.a
