  ...
  extends j
{
  ...
  private final n h;
  private final com.yelp.android.appdata.j i;
  
  public w(String paramString)
  {
    this(paramString, BaseYelpApplication.z().h(), BaseYelpApplication.z().x());
  }
  
  public w(String paramString, n paramn, com.yelp.android.appdata.j paramj)
  {
    super(paramString, x.f());
    h = paramn;
    i = paramj;
  }
  ...
  private String d()
  {
    ...
    localStringBuilder.append(URLEncoder.encode(c(c(), x.h())));
  ...
  public w b(String paramString, double paramDouble)
  {
    return b(paramString, f.a(Double.valueOf(paramDouble)));
  }
  
  public w b(String paramString1, String paramString2)
  {
...
/* Location:
 * Qualified Name:     com.yelp.android.services.w
