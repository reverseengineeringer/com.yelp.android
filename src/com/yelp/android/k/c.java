  ...
  extends Drawable
{
  ...
  public c(Context paramContext)
  {
    ...
    a.setAntiAlias(true);
    paramContext = paramContext.getTheme().obtainStyledAttributes(null, a.k.DrawerArrowToggle, a.a.drawerArrowStyle, a.j.Base_Widget_AppCompat_DrawerArrowToggle);
    a(paramContext.getColor(a.k.DrawerArrowToggle_color, 0));
    b(paramContext.getDimension(a.k.DrawerArrowToggle_thickness, 0.0F));
    a(paramContext.getBoolean(a.k.DrawerArrowToggle_spinBars, true));
    c(Math.round(paramContext.getDimension(a.k.DrawerArrowToggle_gapBetweenBars, 0.0F)));
    i = paramContext.getDimensionPixelSize(a.k.DrawerArrowToggle_drawableSize, 0);
    d = Math.round(paramContext.getDimension(a.k.DrawerArrowToggle_barLength, 0.0F));
    c = Math.round(paramContext.getDimension(a.k.DrawerArrowToggle_arrowHeadLength, 0.0F));
    e = paramContext.getDimension(a.k.DrawerArrowToggle_arrowShaftLength, 0.0F);
...
/* Location:
 * Qualified Name:     com.yelp.android.k.c
