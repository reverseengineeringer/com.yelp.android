  ...
  implements t
{
  ...
  public j(String paramString1, String paramString2, AsyncTask<?, ?, SQLiteDatabase> paramAsyncTask)
  {
    b = paramString1;
    c = paramString2;
    a = paramAsyncTask;
  ...
  public static final ab a(String paramString)
  {
    return new ab(paramString).a(new p("_id", ColumnType.INTEGER, ColumnModifier.PRIMARY_KEY_AUTOINCREMENT));
  }
  
  public static y a(aa paramaa, String paramString)
  {
    return new k(paramaa);
  }
  ...
  private void b(String paramString)
  {
    ...
    //   3: astore 4
    //   5: aload_0
    //   6: getfield 31	com/yelp/android/database/j:a	Landroid/os/AsyncTask;
    ...
    //   20: aload_0
    //   21: getfield 25	com/yelp/android/database/j:d	Ljava/util/ArrayList;
    //   24: iconst_0
    //   25: aload_1
    //   26: invokevirtual 93	java/util/ArrayList:add	(ILjava/lang/Object;)V
    //   29: aload_3
    //   30: aload_0
    //   31: getfield 27	com/yelp/android/database/j:b	Ljava/lang/String;
    //   34: aconst_null
    //   35: aload_0
    //   36: aload_1
    //   37: invokespecial 97	com/yelp/android/database/j:e	(Ljava/lang/String;)Landroid/content/ContentValues;
    ...
    //   47: ifne +25 -> 72
    //   50: aload_0
    //   51: getfield 27	com/yelp/android/database/j:b	Ljava/lang/String;
    //   54: ldc 105
    //   56: iconst_1
    ...
    //   67: aload_3
    //   68: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   71: return
    //   72: aload_0
    //   73: getfield 25	com/yelp/android/database/j:d	Ljava/util/ArrayList;
    //   76: invokevirtual 116	java/util/ArrayList:size	()I
    //   79: bipush 75
    //   81: if_icmple +109 -> 190
    //   84: aload_0
    //   85: getfield 25	com/yelp/android/database/j:d	Ljava/util/ArrayList;
    //   88: iconst_0
    ...
    //   96: aload_3
    //   97: aload_0
    //   98: getfield 27	com/yelp/android/database/j:b	Ljava/lang/String;
    //   101: new 124	java/lang/StringBuilder
    //   104: dup
    //   105: invokespecial 125	java/lang/StringBuilder:<init>	()V
    //   108: aload_0
    //   109: getfield 29	com/yelp/android/database/j:c	Ljava/lang/String;
    ...
    //   147: astore_2
    //   148: aload_0
    //   149: getfield 27	com/yelp/android/database/j:b	Ljava/lang/String;
    ...
    //   185: aload_1
    //   186: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   189: return
    //   190: aload_3
    //   191: invokevirtual 151	android/database/sqlite/SQLiteDatabase:setTransactionSuccessful	()V
    //   194: aload_3
    //   195: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   198: return
    //   199: astore_1
    //   200: aload_2
    //   201: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   204: aload_1
    //   205: athrow
    //   206: astore_1
    //   207: aload_3
  ...
  private void c(String paramString)
  {
    ...
    //   3: astore 4
    //   5: aload_0
    //   6: getfield 25	com/yelp/android/database/j:d	Ljava/util/ArrayList;
    //   9: iconst_0
    //   10: aload_1
    //   11: invokevirtual 93	java/util/ArrayList:add	(ILjava/lang/Object;)V
    //   14: aload_0
    //   15: getfield 31	com/yelp/android/database/j:a	Landroid/os/AsyncTask;
    ...
    //   76: aload_3
    //   77: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   80: return
    //   81: astore_3
    //   82: aload 4
    //   84: astore_1
    ...
    //   86: astore_2
    //   87: aload_0
    //   88: getfield 27	com/yelp/android/database/j:b	Ljava/lang/String;
    ...
    //   124: aload_1
    //   125: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   128: return
    //   129: astore_1
    //   130: aload_2
    //   131: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   134: aload_1
    //   135: athrow
    //   136: astore_1
    //   137: aload_3
  ...
  private void d(String paramString)
  {
    ...
    //   31: aload 4
    //   33: aload_0
    //   34: getfield 27	com/yelp/android/database/j:b	Ljava/lang/String;
    //   37: new 124	java/lang/StringBuilder
    //   40: dup
    //   41: invokespecial 125	java/lang/StringBuilder:<init>	()V
    //   44: aload_0
    //   45: getfield 29	com/yelp/android/database/j:c	Ljava/lang/String;
    ...
    //   73: if_icmpeq +29 -> 102
    //   76: aload_0
    //   77: getfield 27	com/yelp/android/database/j:b	Ljava/lang/String;
    //   80: ldc -99
    //   82: iconst_1
    ...
    //   96: aload 4
    //   98: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   101: return
    //   102: aload 4
    //   104: aload_0
    //   105: getfield 27	com/yelp/android/database/j:b	Ljava/lang/String;
    //   108: aconst_null
    //   109: aload_0
    //   110: aload_1
    //   111: invokespecial 97	com/yelp/android/database/j:e	(Ljava/lang/String;)Landroid/content/ContentValues;
    ...
    //   121: ifne +26 -> 147
    //   124: aload_0
    //   125: getfield 27	com/yelp/android/database/j:b	Ljava/lang/String;
    //   128: ldc -92
    //   130: iconst_1
    ...
    //   141: aload 4
    //   143: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   146: return
    //   147: aload 4
    //   149: invokevirtual 151	android/database/sqlite/SQLiteDatabase:setTransactionSuccessful	()V
    //   152: aload 4
    //   154: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   157: return
    //   158: astore 4
    //   160: aload 5
    //   162: astore_1
    ...
    //   164: astore_3
    //   165: aload_0
    //   166: getfield 27	com/yelp/android/database/j:b	Ljava/lang/String;
    //   169: ldc -90
    //   171: iconst_1
    ...
    //   183: aload_1
    //   184: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   187: return
    //   188: astore_1
    //   189: aload_3
    //   190: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   193: aload_1
    //   194: athrow
    //   195: astore_1
    //   196: aload 4
  ...
  public void c()
  {
    ...
    //   12: aload_0
    //   13: getfield 31	com/yelp/android/database/j:a	Landroid/os/AsyncTask;
    ...
    //   27: aload_3
    //   28: aload_0
    //   29: getfield 27	com/yelp/android/database/j:b	Ljava/lang/String;
    //   32: ldc -19
    //   34: aconst_null
    ...
    //   38: istore_1
    //   39: aload_0
    //   40: getfield 27	com/yelp/android/database/j:b	Ljava/lang/String;
    //   43: ldc -17
    //   45: iconst_1
    ...
    //   63: aload_3
    //   64: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   67: return
    //   68: astore_2
    //   69: aload 4
    //   71: astore_3
    ...
    //   76: astore_2
    //   77: aload_0
    //   78: getfield 27	com/yelp/android/database/j:b	Ljava/lang/String;
    ...
    //   116: aload_3
    //   117: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   120: return
    //   121: astore 4
    //   123: aload_2
    //   124: astore_3
    ...
    //   127: astore_2
    //   128: aload_3
    //   129: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   132: aload_2
    //   133: athrow
    //   134: astore_2
    //   135: goto -7 -> 128
  ...
  public void d()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 25	com/yelp/android/database/j:d	Ljava/util/ArrayList;
    //   4: invokevirtual 243	java/util/ArrayList:isEmpty	()Z
    //   7: ifeq +4 -> 11
    //   10: return
    //   11: aload_0
    //   12: getfield 25	com/yelp/android/database/j:d	Ljava/util/ArrayList;
    //   15: aload_0
    //   16: getfield 25	com/yelp/android/database/j:d	Ljava/util/ArrayList;
    ...
    //   35: astore_3
    //   36: aload_0
    //   37: getfield 31	com/yelp/android/database/j:a	Landroid/os/AsyncTask;
    ...
    //   51: aload_2
    //   52: aload_0
    //   53: getfield 27	com/yelp/android/database/j:b	Ljava/lang/String;
    //   56: new 124	java/lang/StringBuilder
    //   59: dup
    //   60: invokespecial 125	java/lang/StringBuilder:<init>	()V
    //   63: aload_0
    //   64: getfield 29	com/yelp/android/database/j:c	Ljava/lang/String;
    ...
    //   95: aload_2
    //   96: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   99: return
    //   100: astore_1
    //   101: aload_3
    //   102: astore_2
    ...
    //   106: astore_1
    //   107: aload_0
    //   108: getfield 27	com/yelp/android/database/j:b	Ljava/lang/String;
    //   111: ldc -9
    //   113: iconst_1
    //   114: anewarray 4	java/lang/Object
    //   117: dup
    ...
    //   133: astore_1
    //   134: aload_2
    //   135: invokestatic 112	com/yelp/android/database/j:b	(Landroid/database/sqlite/SQLiteDatabase;)V
    //   138: aload_1
    //   139: athrow
    //   140: astore_1
    //   141: goto -7 -> 134
