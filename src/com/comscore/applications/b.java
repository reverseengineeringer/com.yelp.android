  ...
  extends c
{
  protected b(com.comscore.analytics.a parama, EventType paramEventType, String paramString, boolean paramBoolean)
  {
    ...
    b(new com.yelp.android.ar.a("ns_ap_gs", String.valueOf(parama.H()), Boolean.valueOf(false)));
    b(new com.yelp.android.ar.a("ns_ap_install", String.valueOf(parama.G()), Boolean.valueOf(false)));
    b(new com.yelp.android.ar.a("ns_ap_runs", String.valueOf(parama.F()), Boolean.valueOf(false)));
    if (paramBoolean) {
      b(new com.yelp.android.ar.a("ns_ap_csf", "1", Boolean.valueOf(false)));
    }
    paramEventType = "0";
    if (l.a()) {
      paramEventType = "1";
    }
    b(new com.yelp.android.ar.a("ns_ap_jb", paramEventType, Boolean.valueOf(false)));
    b(new com.yelp.android.ar.a("ns_ap_lastrun", String.valueOf(parama.Y()), Boolean.valueOf(false)));
    paramEventType = parama.L();
    if ((paramEventType != null) && (paramEventType.length() > 0)) {
      b(new com.yelp.android.ar.a("ns_ap_updated", paramEventType, Boolean.valueOf(false)));
    }
    paramEventType = parama.r().b("exception_ocurrences");
    if ((paramEventType != null) && (paramEventType.length() > 0) && (!paramEventType.equals("0")))
    {
      b(new com.yelp.android.ar.a("ns_ap_er", paramEventType, Boolean.valueOf(false)));
