...
class c
{
  ...
  public c(IdManager paramIdManager)
  {
    Object localObject = new byte[10];
    a((byte[])localObject);
    b((byte[])localObject);
    c((byte[])localObject);
    paramIdManager = CommonUtils.a(paramIdManager.b());
    localObject = CommonUtils.a((byte[])localObject);
    b = String.format(Locale.US, "%s-%s-%s-%s", new Object[] { ((String)localObject).substring(0, 12), ((String)localObject).substring(12, 16), ((String)localObject).subSequence(16, 20), paramIdManager.substring(0, 12) }).toUpperCase(Locale.US);
  }
