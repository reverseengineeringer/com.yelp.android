  ...
  implements RequestBatch.Callback
{
  ...
  public void onBatchCompleted(RequestBatch paramRequestBatch)
  {
    ...
    {
      LikeActionController.access$2100(this$1.this$0, this$1.val$activity, this$1.val$analyticsParameters, false);
      return;
    }
    LikeActionController.access$1202(this$1.this$0, Utility.coerceValueIfNullOrEmpty(val$likeRequest.unlikeToken, null));
    LikeActionController.access$2202(this$1.this$0, true);
    LikeActionController.access$1300(this$1.this$0).logSdkEvent("fb_like_control_did_like", null, this$1.val$analyticsParameters);
