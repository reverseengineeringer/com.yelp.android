  ...
  extends LikeActionController.AbstractRequestWrapper
{
  ...
  protected void processError(FacebookRequestError paramFacebookRequestError)
  {
    ...
    Logger.log(LoggingBehavior.REQUESTS, LikeActionController.access$1500(), "Error getting the FB id for object '%s' : %s", new Object[] { objectId, paramFacebookRequestError });
  }
