...
{
  String likeCountStringWithLike = LikeActionController.access$800(this$0);
  String likeCountStringWithoutLike = LikeActionController.access$900(this$0);
  String socialSentenceStringWithLike = LikeActionController.access$1000(this$0);
  String socialSentenceStringWithoutLike = LikeActionController.access$1100(this$0);
  ...
  {
    Logger.log(LoggingBehavior.REQUESTS, LikeActionController.access$1500(), "Error fetching engagement for object '%s' : %s", new Object[] { objectId, paramFacebookRequestError });
