  ...
  extends LikeActionController.AbstractRequestWrapper
{
  ...
  {
    Logger.log(LoggingBehavior.REQUESTS, LikeActionController.access$1500(), "Error unliking object with unlike token '%s' : %s", new Object[] { unlikeToken, paramFacebookRequestError });
