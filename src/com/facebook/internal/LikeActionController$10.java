  ...
  implements RequestBatch.Callback
{
  ...
  public void onBatchCompleted(RequestBatch paramRequestBatch)
  {
    ...
    if (Utility.isNullOrEmpty(LikeActionController.access$1900(this$0)))
    {
      Logger.log(LoggingBehavior.DEVELOPER_ERRORS, LikeActionController.access$1500(), "Unable to verify the FB id for '%s'. Verify that it is a valid FB object or page", new Object[] { LikeActionController.access$2400(this$0) });
