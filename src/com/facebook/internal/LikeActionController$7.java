  ...
  implements RequestBatch.Callback
{
  ...
  public void onBatchCompleted(RequestBatch paramRequestBatch)
  {
    ...
    {
      LikeActionController.access$2100(this$0, val$activity, val$analyticsParameters, true);
      return;
    }
    LikeActionController.access$1202(this$0, null);
    LikeActionController.access$2202(this$0, false);
    LikeActionController.access$1300(this$0).logSdkEvent("fb_like_control_did_unlike", null, val$analyticsParameters);
