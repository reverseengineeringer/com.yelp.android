  ...
  implements FacebookDialog.Callback
{
  ...
  public void onComplete(FacebookDialog.PendingCall paramPendingCall, Bundle paramBundle)
  {
    ...
    Object localObject1 = LikeActionController.access$800(this$0);
    String str1 = LikeActionController.access$900(this$0);
    if (paramBundle.containsKey("like_count_string"))
    {
      str1 = paramBundle.getString("like_count_string");
      localObject1 = str1;
    }
    Object localObject2 = LikeActionController.access$1000(this$0);
    String str2 = LikeActionController.access$1100(this$0);
    ...
    for (Bundle localBundle = new Bundle();; localBundle = val$analyticsParameters)
    {
      ...
      LikeActionController.access$1300(this$0).logSdkEvent("fb_like_control_dialog_did_succeed", null, localBundle);
      LikeActionController.access$1400(this$0, bool, (String)localObject1, str1, (String)localObject2, str2, paramBundle);
      return;
      paramBundle = LikeActionController.access$1200(this$0);
      break;
    }
  }
  ...
  {
    Logger.log(LoggingBehavior.REQUESTS, LikeActionController.access$1500(), "Like Dialog failed with error : %s", new Object[] { paramException });
    if (val$analyticsParameters == null) {}
    for (paramException = new Bundle();; paramException = val$analyticsParameters)
    {
      ...
      LikeActionController.access$1600(this$0, "present_dialog", paramException);
      LikeActionController.access$1800(LikeActionController.access$1700(this$0), this$0, "com.facebook.sdk.LikeActionController.DID_ERROR", paramBundle);
      return;
    }
  }
}
