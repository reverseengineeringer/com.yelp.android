  ...
  extends LikeActionController.AbstractRequestWrapper
{
  ...
  {
    Logger.log(LoggingBehavior.REQUESTS, LikeActionController.access$1500(), "Error fetching like status for object '%s' : %s", new Object[] { objectId, paramFacebookRequestError });
