...
public class LikeActionController
{
  ...
  private static void broadcastAction(Context paramContext, LikeActionController paramLikeActionController, String paramString, Bundle paramBundle)
  {
    ...
    u.a(paramContext.getApplicationContext()).a(localIntent);
  }
  ...
  private static LikeActionController deserializeFromDiskSynchronously(Context paramContext, String paramString)
  {
    ...
    //   10: astore_1
    //   11: getstatic 269	com/facebook/internal/LikeActionController:controllerDiskCache	Lcom/facebook/internal/FileLruCache;
    //   14: aload_1
    ...
    //   27: astore_2
    //   28: aload_1
    //   29: invokestatic 384	com/facebook/internal/Utility:readStreamToString	(Ljava/io/InputStream;)Ljava/lang/String;
    //   32: astore 6
    //   34: aload 5
    //   36: astore_3
    //   37: aload_1
    //   38: astore_2
    //   39: aload 6
    //   41: invokestatic 388	com/facebook/internal/Utility:isNullOrEmpty	(Ljava/lang/String;)Z
    //   44: ifne +12 -> 56
    //   47: aload_1
    //   48: astore_2
    //   49: aload_0
    //   50: aload 6
    //   52: invokestatic 391	com/facebook/internal/LikeActionController:deserializeFromJson	(Landroid/content/Context;Ljava/lang/String;)Lcom/facebook/internal/LikeActionController;
    //   55: astore_3
    //   56: aload_3
    //   57: astore_0
    //   58: aload_1
    //   59: ifnull +9 -> 68
    //   62: aload_1
    //   63: invokestatic 395	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   66: aload_3
    //   67: astore_0
    //   68: aload_0
    //   69: areturn
    ...
    //   78: ldc_w 397
    //   81: aload_0
    //   82: invokestatic 403	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    //   85: pop
    //   86: aload 4
    //   88: astore_0
    //   89: aload_1
    //   90: ifnull -22 -> 68
    //   93: aload_1
    //   94: invokestatic 395	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   97: aconst_null
    //   98: areturn
    //   99: astore_0
    //   100: aconst_null
    ...
    //   103: ifnull +7 -> 110
    //   106: aload_2
    //   107: invokestatic 395	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   110: aload_0
    //   111: athrow
    //   112: astore_0
    //   113: goto -11 -> 102
  ...
  public static boolean handleOnActivityResult(Context paramContext, int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    getControllerForObjectId(paramContext, objectIdForPendingController, new LikeActionController.1(paramInt1, paramInt2, paramIntent, localUUID));
    return true;
  }
  ...
  private static void performFirstInitialize(Context paramContext)
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: getstatic 514	com/facebook/internal/LikeActionController:isInitialized	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +7 -> 15
    //   11: ldc 2
    ...
    //   18: dup
    //   19: invokestatic 622	android/os/Looper:getMainLooper	()Landroid/os/Looper;
    //   22: invokespecial 625	android/os/Handler:<init>	(Landroid/os/Looper;)V
    //   25: putstatic 277	com/facebook/internal/LikeActionController:handler	Landroid/os/Handler;
    //   28: aload_0
    //   29: ldc 56
    //   31: iconst_0
    //   32: invokevirtual 555	android/content/Context:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   35: ldc 59
    //   37: iconst_1
    //   38: invokeinterface 628 3 0
    //   43: putstatic 256	com/facebook/internal/LikeActionController:objectSuffix	I
    ...
    //   54: new 630	com/facebook/internal/FileLruCache$Limits
    //   57: dup
    //   58: invokespecial 631	com/facebook/internal/FileLruCache$Limits:<init>	()V
    //   61: invokespecial 634	com/facebook/internal/FileLruCache:<init>	(Landroid/content/Context;Ljava/lang/String;Lcom/facebook/internal/FileLruCache$Limits;)V
    //   64: putstatic 269	com/facebook/internal/LikeActionController:controllerDiskCache	Lcom/facebook/internal/FileLruCache;
    //   67: aload_0
    //   68: invokestatic 637	com/facebook/internal/LikeActionController:registerSessionBroadcastReceivers	(Landroid/content/Context;)V
    //   71: iconst_1
    //   72: putstatic 514	com/facebook/internal/LikeActionController:isInitialized	Z
    //   75: goto -64 -> 11
    //   78: astore_0
    //   79: ldc 2
    //   81: monitorexit
  ...
  private void publishUnlikeAsync(Activity paramActivity, Bundle paramBundle)
  {
    ...
    localRequestBatch.addCallback(new LikeActionController.7(this, localPublishUnlikeRequestWrapper, paramActivity, paramBundle));
    localRequestBatch.executeAsync();
  }
