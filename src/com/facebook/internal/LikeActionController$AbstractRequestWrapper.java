...
abstract class LikeActionController$AbstractRequestWrapper
{
  ...
  {
    Logger.log(LoggingBehavior.REQUESTS, LikeActionController.access$1500(), "Error running request for object '%s' : %s", new Object[] { objectId, paramFacebookRequestError });
  }
