  ...
  extends FrameLayout
{
  ...
  private void associateWithLikeActionController(LikeActionController paramLikeActionController)
  {
    ...
    paramLikeActionController = u.a(getContext());
    ...
    paramLikeActionController.a(broadcastReceiver, localIntentFilter);
  }
  ...
  private void tearDownObjectAssociations()
  {
    ...
    {
      u.a(getContext()).a(broadcastReceiver);
  ...
  private void toggleLike()
  {
    if (likeActionController != null)
    {
      ...
      likeActionController.toggleLike(localActivity, getAnalyticsParameters());
    }
  }
