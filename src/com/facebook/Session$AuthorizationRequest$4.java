  ...
  implements AuthorizationClient.StartActivityDelegate
{
  ...
  {
    return Session.AuthorizationRequest.access$1900(this$0).getActivityContext();
  }
  
  public void startActivityForResult(Intent paramIntent, int paramInt)
  {
    Session.AuthorizationRequest.access$1900(this$0).startActivityForResult(paramIntent, paramInt);
  }
}
