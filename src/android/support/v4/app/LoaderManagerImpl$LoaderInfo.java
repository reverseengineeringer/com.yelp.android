  ...
  implements t<Object>
{
  ...
  android.support.v4.content.r<Object> mLoader;
  ...
  void callOnLoadFinished(android.support.v4.content.r<Object> paramr, Object paramObject)
  {
    String str;
    if (mCallbacks != null)
    {
    ...
    for (;;)
    {
      try
      {
        if (LoaderManagerImpl.DEBUG) {
          Log.v("LoaderManager", "  onLoadFinished in " + paramr + ": " + paramr.dataToString(paramObject));
        }
        mCallbacks.onLoadFinished(paramr, paramObject);
        if (this$0.mActivity != null) {
  ...
  public void onLoadComplete(android.support.v4.content.r<Object> paramr, Object paramObject)
  {
    if (LoaderManagerImpl.DEBUG) {
    ...
    do
    {
      ...
      if ((mData != paramObject) || (!mHaveData))
      {
        ...
        mHaveData = true;
        if (mStarted) {
          callOnLoadFinished(paramr, paramObject);
        }
      }
      paramr = (LoaderInfo)this$0.mInactiveLoaders.a(mId);
      if ((paramr != null) && (paramr != this))
      {
        mDeliveredData = false;
        paramr.destroy();
        this$0.mInactiveLoaders.c(mId);
      }
