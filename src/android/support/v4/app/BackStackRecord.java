  ...
  implements FragmentManager.BackStackEntry, Runnable
{
  ...
  private void callSharedElementEnd(BackStackRecord.TransitionState paramTransitionState, Fragment paramFragment1, Fragment paramFragment2, boolean paramBoolean, a<String, View> parama)
  {
    if (paramBoolean) {}
    for (paramTransitionState = mEnterTransitionCallback;; paramTransitionState = mEnterTransitionCallback)
    {
      if (paramTransitionState != null) {
        paramTransitionState.onSharedElementEnd(new ArrayList(parama.keySet()), new ArrayList(parama.values()), null);
      }
      return;
    }
  }
  
  private static Object captureExitingViews(Object paramObject, Fragment paramFragment, ArrayList<View> paramArrayList, a<String, View> parama, View paramView)
  {
    Object localObject = paramObject;
    if (paramObject != null) {
      localObject = FragmentTransitionCompat21.captureExitingViews(paramObject, paramFragment.getView(), paramArrayList, parama, paramView);
    }
    return localObject;
  }
  ...
  private boolean configureTransitions(int paramInt, BackStackRecord.TransitionState paramTransitionState, boolean paramBoolean, SparseArray<Fragment> paramSparseArray1, SparseArray<Fragment> paramSparseArray2)
  {
    ...
    if (localObject4 != null)
    {
      ...
      localArrayList.addAll(((a)localObject1).values());
      if (!paramBoolean) {
        break label455;
      }
      ...
      {
        paramSparseArray2.onSharedElementStart(new ArrayList(((a)localObject1).keySet()), new ArrayList(((a)localObject1).values()), null);
        paramSparseArray1 = (SparseArray<Fragment>)localObject1;
      }
    }
  ...
  private a<String, View> mapEnteringSharedElements(BackStackRecord.TransitionState paramTransitionState, Fragment paramFragment, boolean paramBoolean)
  {
    a locala = new a();
    paramFragment = paramFragment.getView();
    paramTransitionState = locala;
    if (paramFragment != null)
    {
      paramTransitionState = locala;
      if (mSharedElementSourceNames != null)
      {
        FragmentTransitionCompat21.findNamedViews(locala, paramFragment);
        if (!paramBoolean) {
          break label57;
        }
        paramTransitionState = remapNames(mSharedElementSourceNames, mSharedElementTargetNames, locala);
      }
    }
    return paramTransitionState;
    label57:
    locala.a(mSharedElementTargetNames);
    return locala;
  }
  
  private a<String, View> mapSharedElementsIn(BackStackRecord.TransitionState paramTransitionState, boolean paramBoolean, Fragment paramFragment)
  {
    a locala = mapEnteringSharedElements(paramTransitionState, paramFragment, paramBoolean);
    if (paramBoolean)
    {
      if (mExitTransitionCallback != null) {
        mExitTransitionCallback.onMapSharedElements(mSharedElementTargetNames, locala);
      }
      setBackNameOverrides(paramTransitionState, locala, true);
      return locala;
    }
    if (mEnterTransitionCallback != null) {
      mEnterTransitionCallback.onMapSharedElements(mSharedElementTargetNames, locala);
    }
    setNameOverrides(paramTransitionState, locala, true);
    return locala;
  }
  ...
  private static a<String, View> remapNames(ArrayList<String> paramArrayList1, ArrayList<String> paramArrayList2, a<String, View> parama)
  {
    if (parama.isEmpty()) {
      return parama;
    }
  ...
  private a<String, View> remapSharedElements(BackStackRecord.TransitionState paramTransitionState, Fragment paramFragment, boolean paramBoolean)
  {
    a locala2 = new a();
    a locala1 = locala2;
    if (mSharedElementSourceNames != null)
    {
      FragmentTransitionCompat21.findNamedViews(locala2, paramFragment.getView());
      if (!paramBoolean) {
        break label82;
      }
      locala2.a(mSharedElementTargetNames);
    }
    label82:
    for (locala1 = locala2; paramBoolean; locala1 = remapNames(mSharedElementSourceNames, mSharedElementTargetNames, locala2))
    {
      if (mEnterTransitionCallback != null) {
        mEnterTransitionCallback.onMapSharedElements(mSharedElementTargetNames, locala1);
      }
      setBackNameOverrides(paramTransitionState, locala1, false);
      return locala1;
    }
    if (mExitTransitionCallback != null) {
      mExitTransitionCallback.onMapSharedElements(mSharedElementTargetNames, locala1);
    }
    setNameOverrides(paramTransitionState, locala1, false);
    return locala1;
  }
  
  private void setBackNameOverrides(BackStackRecord.TransitionState paramTransitionState, a<String, View> parama, boolean paramBoolean)
  {
    int i;
    int j;
    label13:
    ...
    if (mSharedElementTargetNames == null)
    {
      ...
      localObject = (View)parama.get((String)mSharedElementTargetNames.get(j));
      if (localObject != null)
      {
  ...
  private void setEpicenterIn(a<String, View> parama, BackStackRecord.TransitionState paramTransitionState)
  {
    if ((mSharedElementTargetNames != null) && (!parama.isEmpty()))
    {
      parama = (View)parama.get(mSharedElementTargetNames.get(0));
      if (parama != null) {
        enteringEpicenterView.epicenter = parama;
      }
    }
  }
  ...
  private static void setNameOverride(a<String, String> parama, String paramString1, String paramString2)
  {
    int i;
    ...
    while (i < parama.size())
    {
      if (paramString1.equals(parama.c(i)))
      {
        parama.a(i, paramString2);
        return;
      }
      i += 1;
    }
  ...
  private void setNameOverrides(BackStackRecord.TransitionState paramTransitionState, a<String, View> parama, boolean paramBoolean)
  {
    int j = parama.size();
    int i = 0;
    if (i < j)
    {
      String str1 = (String)parama.b(i);
      String str2 = FragmentTransitionCompat21.getTransitionName((View)parama.c(i));
      if (paramBoolean) {
