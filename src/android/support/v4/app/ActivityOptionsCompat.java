...
public class ActivityOptionsCompat
{
  ...
  public static ActivityOptionsCompat makeSceneTransitionAnimation(Activity paramActivity, m<View, String>... paramVarArgs)
  {
    ...
    if (Build.VERSION.SDK_INT >= 21)
    {
      ...
      {
        localObject[i] = ((View)a);
        arrayOfString[i] = ((String)b);
        i += 1;
      }
    ...
    for (;;)
    {
      ...
      label92:
      arrayOfString = null;
      paramVarArgs = (m<View, String>[])localObject;
