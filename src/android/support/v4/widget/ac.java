...
public class ac
{
  ...
  private ac(Context paramContext, ViewGroup paramViewGroup, a parama)
  {
  ...
  public static ac a(ViewGroup paramViewGroup, float paramFloat, a parama)
  {
  ...
  public static ac a(ViewGroup paramViewGroup, a parama)
  {
    return new ac(paramViewGroup.getContext(), paramViewGroup, parama);
  }
  ...
  {
    int i2 = t.c(paramMotionEvent);
    int i1 = 0;
    while (i1 < i2)
    {
      int i3 = t.b(paramMotionEvent, i1);
      float f1 = t.c(paramMotionEvent, i1);
      float f2 = t.d(paramMotionEvent, i1);
      f[i3] = f1;
      g[i3] = f2;
      i1 += 1;
    }
  ...
  public boolean a(int paramInt1, int paramInt2)
  {
    ...
    return a(paramInt1, paramInt2, (int)ag.a(l, c), (int)ag.b(l, c));
  }
    ...
    case 5: 
      do
      {
        do
        {
          ...
          r.a(i2 & p, i1);
          return;
          i1 = t.b(paramMotionEvent, i3);
          f1 = t.c(paramMotionEvent, i3);
          f2 = t.d(paramMotionEvent, i3);
          a(f1, f2, i1);
          if (a != 0) {
            break;
          }
