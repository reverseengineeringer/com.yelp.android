...
class e
{
  ...
  {
    if ((paramCompoundButton instanceof ab)) {
      ((ab)paramCompoundButton).setSupportButtonTintList(paramColorStateList);
    }
  }
  ...
  {
    if ((paramCompoundButton instanceof ab)) {
      ((ab)paramCompoundButton).setSupportButtonTintMode(paramMode);
    }
  }
}
