  ...
  implements Parcelable
{
  ...
  {
    return new QueueItem(paramObject, MediaDescriptionCompat.fromMediaDescription(f.a(paramObject)), f.b(paramObject));
  }
  ...
  public Object getQueueItem()
  {
    ...
    mItem = f.a(mDescription.getMediaDescription(), mId);
    return mItem;
  }
