...
public class c
{
  ...
  public static File[] getExternalCacheDirs(Context paramContext)
  {
    ...
    if (i >= 8) {}
    for (paramContext = e.a(paramContext);; paramContext = buildPath(Environment.getExternalStorageDirectory(), new String[] { "Android", "data", paramContext.getPackageName(), "cache" })) {
  ...
  public static File[] getExternalFilesDirs(Context paramContext, String paramString)
  {
    int i = Build.VERSION.SDK_INT;
    if (i >= 19) {
      return h.a(paramContext, paramString);
    }
    if (i >= 8) {}
    for (paramContext = e.a(paramContext, paramString);; paramContext = buildPath(Environment.getExternalStorageDirectory(), new String[] { "Android", "data", paramContext.getPackageName(), "files", paramString })) {
      return new File[] { paramContext };
    }
  }
  ...
  public static File[] getObbDirs(Context paramContext)
  {
    ...
    if (i >= 11) {}
    for (paramContext = f.a(paramContext);; paramContext = buildPath(Environment.getExternalStorageDirectory(), new String[] { "Android", "obb", paramContext.getPackageName() })) {
      return new File[] { paramContext };
    }
  }
