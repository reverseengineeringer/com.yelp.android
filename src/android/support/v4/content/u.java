...
public class u
{
  ...
  {
    a = paramContext;
    e = new v(this, paramContext.getMainLooper());
  }
  ...
  public static u a(Context paramContext)
  {
    ...
    {
      if (g == null) {
        g = new u(paramContext.getApplicationContext());
      }
      paramContext = g;
      return paramContext;
    }
  ...
  public boolean a(Intent paramIntent)
  {
    ...
    synchronized (b)
    {
      ...
      localObject = (x)localArrayList2.get(j);
      if (i != 0) {
    ...
    for (;;)
    {
      ...
      {
        d.add(new w(paramIntent, localArrayList1));
        if (!e.hasMessages(1)) {
