  ...
  implements View.OnLongClickListener
{
  ...
  public k$c(k paramk, Context paramContext, ActionBar.b paramb, boolean paramBoolean)
  {
    super(paramContext, null, a.a.actionBarTabStyle);
    c = paramb;
    paramk = p.a(paramContext, null, b, a.a.actionBarTabStyle, 0);
    if (paramk.e(0)) {
      setBackgroundDrawable(paramk.a(0));
    }
    paramk.b();
    if (paramBoolean) {
      setGravity(8388627);
...
/* Location:
 * Qualified Name:     android.support.v7.internal.widget.k.c
