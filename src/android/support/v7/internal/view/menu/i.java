  ...
  implements a
{
  ...
  private void a(int paramInt1, CharSequence paramCharSequence, int paramInt2, Drawable paramDrawable, View paramView)
  {
    ...
    if (paramInt1 > 0)
    {
      ...
      b = android.support.v4.content.c.getDrawable(e(), paramInt2);
    }
    for (;;)
    {
      c = null;
  ...
  {
    boolean bool = true;
    if ((paramBoolean) && (f.getConfiguration().keyboard != 1) && (f.getBoolean(com.yelp.android.g.c.abc_config_showMenuShortcutsWhenKeyboardPresent))) {}
  ...
  public void a(Bundle paramBundle)
  {
    ...
    for (Object localObject1 = null; i1 < i2; localObject1 = localObject3)
    {
      ...
      View localView = as.a(localMenuItem);
  ...
  {
    return (i != null) && (i.a(parami, paramMenuItem));
  }
