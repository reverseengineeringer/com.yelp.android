  ...
  implements View.OnClickListener
{
  ...
  public l(Context paramContext, SearchView paramSearchView, SearchableInfo paramSearchableInfo, WeakHashMap<String, Drawable.ConstantState> paramWeakHashMap)
  {
  ...
  private CharSequence b(CharSequence paramCharSequence)
  {
    if (r == null)
    {
      ...
      d.getTheme().resolveAttribute(a.a.textColorSearchUrl, (TypedValue)localObject, true);
  ...
  public View a(Context paramContext, Cursor paramCursor, ViewGroup paramViewGroup)
  {
    ...
    ((ImageView)paramContext.findViewById(a.f.edit_query)).setImageResource(o);
    return paramContext;
  }
