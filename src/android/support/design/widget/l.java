  ...
  extends b
{
  ...
  {
    super(paramDrawable);
    l = paramResources.getColor(a.c.design_fab_shadow_start_color);
    m = paramResources.getColor(a.c.design_fab_shadow_mid_color);
    n = paramResources.getColor(a.c.design_fab_shadow_end_color);
    b = new Paint(5);
