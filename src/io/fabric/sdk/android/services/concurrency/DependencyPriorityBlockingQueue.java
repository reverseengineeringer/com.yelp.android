...
public class DependencyPriorityBlockingQueue<E extends a,  extends i,  extends f>
  extends PriorityBlockingQueue<E>
{
    ...
    throws InterruptedException
  {
    for (;;)
    {
      a locala = performOperation(paramInt, paramLong, paramTimeUnit);
      if ((locala == null) || (canProcess(locala))) {
        return locala;
      }
      offerBlockedResult(paramInt, locala);
    }
  }
    ...
    throws InterruptedException
  {
    ...
    return (a)super.poll(paramLong.longValue(), paramTimeUnit);
  }
