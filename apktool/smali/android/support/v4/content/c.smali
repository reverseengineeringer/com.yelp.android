...
.method private static declared-synchronized createFilesDir(Ljava/io/File;)Ljava/io/File;
    ...
    .prologue
    .line 377
    const-class v1, Landroid/support/v4/content/c;
...
.method public static getExternalCacheDirs(Landroid/content/Context;)[Ljava/io/File;
    ...
    invoke-static {v0, v1}, Landroid/support/v4/content/c;->buildPath(Ljava/io/File;[Ljava/lang/String;)Ljava/io/File;
...
.method public static getExternalFilesDirs(Landroid/content/Context;Ljava/lang/String;)[Ljava/io/File;
    ...
    .line 220
    invoke-static {p0, p1}, Landroid/support/v4/content/h;->a(Landroid/content/Context;Ljava/lang/String;)[Ljava/io/File;
...
.method public static getObbDirs(Landroid/content/Context;)[Ljava/io/File;
    ...
    .line 160
    invoke-static {p0}, Landroid/support/v4/content/h;->b(Landroid/content/Context;)[Ljava/io/File;
    ...
    .line 164
    invoke-static {p0}, Landroid/support/v4/content/f;->a(Landroid/content/Context;)Ljava/io/File;
...
.method public static startActivities(Landroid/content/Context;[Landroid/content/Intent;Landroid/os/Bundle;)Z
    ...
    .line 105
    invoke-static {p0, p1, p2}, Landroid/support/v4/content/g;->a(Landroid/content/Context;[Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    .line 108
    invoke-static {p0, p1}, Landroid/support/v4/content/f;->a(Landroid/content/Context;[Landroid/content/Intent;)V
...
.method public final getCodeCacheDir(Landroid/content/Context;)Ljava/io/File;
    ...
    .line 369
    invoke-static {p1}, Landroid/support/v4/content/d;->b(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-static {v1}, Landroid/support/v4/content/c;->createFilesDir(Ljava/io/File;)Ljava/io/File;
...
.method public final getNoBackupFilesDir(Landroid/content/Context;)Ljava/io/File;
    ...
    .line 344
    invoke-static {p1}, Landroid/support/v4/content/d;->a(Landroid/content/Context;)Ljava/io/File;
