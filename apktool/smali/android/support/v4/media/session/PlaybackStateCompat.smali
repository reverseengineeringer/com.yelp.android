...
.method synthetic constructor <init>(IJJFJLjava/lang/CharSequence;JLandroid/support/v4/media/session/h;)V
    .locals 0
...
.method synthetic constructor <init>(Landroid/os/Parcel;Landroid/support/v4/media/session/h;)V
    .locals 0
...
.method public static fromPlaybackState(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    invoke-static {p0}, Landroid/support/v4/media/session/j;->a(Ljava/lang/Object;)I

    move-result v1

    invoke-static {p0}, Landroid/support/v4/media/session/j;->b(Ljava/lang/Object;)J

    move-result-wide v2

    invoke-static {p0}, Landroid/support/v4/media/session/j;->c(Ljava/lang/Object;)J

    move-result-wide v4

    invoke-static {p0}, Landroid/support/v4/media/session/j;->d(Ljava/lang/Object;)F

    move-result v6

    invoke-static {p0}, Landroid/support/v4/media/session/j;->e(Ljava/lang/Object;)J

    move-result-wide v7

    invoke-static {p0}, Landroid/support/v4/media/session/j;->f(Ljava/lang/Object;)Ljava/lang/CharSequence;

    move-result-object v9

    invoke-static {p0}, Landroid/support/v4/media/session/j;->g(Ljava/lang/Object;)J
...
.method public getPlaybackState()Ljava/lang/Object;
    ...
    invoke-static/range {v1 .. v11}, Landroid/support/v4/media/session/j;->a(IJJFJLjava/lang/CharSequence;J)Ljava/lang/Object;
