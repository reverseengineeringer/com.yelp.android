...
.method constructor <init>(Landroid/support/v4/widget/SwipeRefreshLayout;)V
    ...
    .prologue
    .line 151
    iput-object p1, p0, Landroid/support/v4/widget/bo;->a:Landroid/support/v4/widget/SwipeRefreshLayout;
...
.method public onAnimationEnd(Landroid/view/animation/Animation;)V
    ...
    .line 162
    iget-object v0, p0, Landroid/support/v4/widget/bo;->a:Landroid/support/v4/widget/SwipeRefreshLayout;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/widget/ai;->setAlpha(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/ai;->start()V
    ...
    invoke-static {v0}, Landroid/support/v4/widget/SwipeRefreshLayout;->d(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/support/v4/widget/bw;
    ...
    invoke-interface {v0}, Landroid/support/v4/widget/bw;->a()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/bo;->a:Landroid/support/v4/widget/SwipeRefreshLayout;
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/ai;->stop()V

    .line 173
    iget-object v0, p0, Landroid/support/v4/widget/bo;->a:Landroid/support/v4/widget/SwipeRefreshLayout;

    invoke-static {v0}, Landroid/support/v4/widget/SwipeRefreshLayout;->e(Landroid/support/v4/widget/SwipeRefreshLayout;)Landroid/support/v4/widget/e;
    ...
    iget-object v2, p0, Landroid/support/v4/widget/bo;->a:Landroid/support/v4/widget/SwipeRefreshLayout;
