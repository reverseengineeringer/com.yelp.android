...
.field private final d:Landroid/support/v4/widget/p;
...
.field private final i:Landroid/support/v4/widget/bx;

.field private final j:Landroid/support/v4/widget/bx;

.field private final k:Landroid/support/v4/widget/v;

.field private final l:Landroid/support/v4/widget/v;
...
.field private t:Landroid/support/v4/widget/t;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/q;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/p;-><init>(Landroid/support/v4/widget/DrawerLayout;)V

    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/p;
    ...
    invoke-direct {v1, p0, v2}, Landroid/support/v4/widget/v;-><init>(Landroid/support/v4/widget/DrawerLayout;I)V

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/v;
    ...
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/v;

    .line 342
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/v;

    invoke-static {p0, v4, v1}, Landroid/support/v4/widget/bx;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/ca;)Landroid/support/v4/widget/bx;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bx;

    .line 343
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bx;

    invoke-virtual {v1, v3}, Landroid/support/v4/widget/bx;->a(I)V

    .line 344
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bx;

    invoke-virtual {v1, v0}, Landroid/support/v4/widget/bx;->a(F)V

    .line 345
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/v;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bx;

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/v;->a(Landroid/support/v4/widget/bx;)V

    .line 347
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/v;

    invoke-static {p0, v4, v1}, Landroid/support/v4/widget/bx;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/ca;)Landroid/support/v4/widget/bx;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bx;

    .line 348
    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bx;

    const/4 v2, 0x2

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/bx;->a(I)V
    ...
    .line 350
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/v;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bx;

    invoke-virtual {v0, v1}, Landroid/support/v4/widget/v;->a(Landroid/support/v4/widget/bx;)V

    .line 353
    invoke-virtual {p0, v3}, Landroid/support/v4/widget/DrawerLayout;->setFocusableInTouchMode(Z)V

    .line 355
    invoke-static {p0, v3}, Landroid/support/v4/view/ce;->c(Landroid/view/View;I)V
    ...
    invoke-static {p0, v0}, Landroid/support/v4/view/df;->a(Landroid/view/ViewGroup;Z)V

    .line 360
    invoke-static {p0}, Landroid/support/v4/view/ce;->u(Landroid/view/View;)Z
    ...
    .line 361
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/q;

    invoke-interface {v0, p0}, Landroid/support/v4/widget/q;->a(Landroid/view/View;)V

    .line 362
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/q;

    invoke-interface {v0, p1}, Landroid/support/v4/widget/q;->a(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method private a(Landroid/view/View;Z)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/ce;->c(Landroid/view/View;I)V
...
.method public a(II)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bx;

    .line 483
    :goto_1
    invoke-virtual {v0}, Landroid/support/v4/widget/bx;->e()V
    ...
    .line 482
    :cond_4
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bx;
...
.method a(IILandroid/view/View;)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/bx;->a()I

    move-result v2

    .line 612
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bx;

    invoke-virtual {v3}, Landroid/support/v4/widget/bx;->a()I
    ...
    .line 635
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->t:Landroid/support/v4/widget/t;
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/widget/t;->onDrawerStateChanged(I)V
...
.method a(Landroid/view/View;F)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/widget/t;->onDrawerSlide(Landroid/view/View;F)V
...
.method a(Z)V
    ...
    .line 1268
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bx;
    ...
    invoke-virtual {v7, v5, v6, v8}, Landroid/support/v4/widget/bx;->a(Landroid/view/View;II)Z
    ...
    .line 1271
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bx;
    ...
    invoke-virtual {v6, v5, v7, v8}, Landroid/support/v4/widget/bx;->a(Landroid/view/View;II)Z
    ...
    .line 1278
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/v;

    invoke-virtual {v0}, Landroid/support/v4/widget/v;->a()V
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 1571
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/p;
...
.method b(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/t;->onDrawerClosed(Landroid/view/View;)V
...
.method c(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/t;->onDrawerOpened(Landroid/view/View;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/bx;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bx;

    invoke-virtual {v1, v4}, Landroid/support/v4/widget/bx;->a(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/bx;->b()I
    ...
    invoke-virtual {v3}, Landroid/support/v4/widget/bx;->b()I
...
.method public h(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/support/v4/widget/bx;->a(Landroid/view/View;II)Z
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/widget/q;->a(Ljava/lang/Object;)I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1140
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bx;

    invoke-virtual {v3, p1}, Landroid/support/v4/widget/bx;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bx;

    invoke-virtual {v4, p1}, Landroid/support/v4/widget/bx;->a(Landroid/view/MotionEvent;)Z
    ...
    .line 1152
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bx;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/bx;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/bx;->d(I)Z
...
.method protected onMeasure(II)V
    ...
    .line 855
    invoke-static {v8}, Landroid/support/v4/view/ce;->u(Landroid/view/View;)Z
    ...
    .line 856
    sget-object v10, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/q;

    iget-object v11, p0, Landroid/support/v4/widget/DrawerLayout;->B:Ljava/lang/Object;

    invoke-interface {v10, v8, v11, v9}, Landroid/support/v4/widget/q;->a(Landroid/view/View;Ljava/lang/Object;I)V
    ...
    invoke-interface {v10, v0, v11, v9}, Landroid/support/v4/widget/q;->a(Landroid/view/ViewGroup$MarginLayoutParams;Ljava/lang/Object;I)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/bx;->b(Landroid/view/MotionEvent;)V
    ...
    .line 1205
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bx;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/bx;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v4}, Landroid/support/v4/widget/bx;->d()I
...
.method public setDrawerListener(Landroid/support/v4/widget/t;)V
    .locals 0

    .prologue
    .line 432
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->t:Landroid/support/v4/widget/t;
