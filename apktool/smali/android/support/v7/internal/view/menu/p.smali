...
.field private e:Landroid/support/v7/internal/view/menu/h;
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/internal/view/menu/f;Landroid/support/v7/internal/view/menu/h;)V
    ...
    .line 40
    iput-object p2, p0, Landroid/support/v7/internal/view/menu/p;->d:Landroid/support/v7/internal/view/menu/f;

    .line 41
    iput-object p3, p0, Landroid/support/v7/internal/view/menu/p;->e:Landroid/support/v7/internal/view/menu/h;
...
.method public a()Ljava/lang/String;
    ...
    .prologue
    .line 135
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/p;->e:Landroid/support/v7/internal/view/menu/h;
    ...
    invoke-super {p0}, Landroid/support/v7/internal/view/menu/f;->a()Ljava/lang/String;
...
.method public a(Landroid/support/v7/internal/view/menu/f$a;)V
    ...
    .prologue
    .line 74
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/p;->d:Landroid/support/v7/internal/view/menu/f;
...
.method public c(Landroid/support/v7/internal/view/menu/h;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/internal/view/menu/f;->c(Landroid/support/v7/internal/view/menu/h;)Z
...
.method public d(Landroid/support/v7/internal/view/menu/h;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/internal/view/menu/f;->d(Landroid/support/v7/internal/view/menu/h;)Z
...
.method public setHeaderIcon(I)Landroid/view/SubMenu;
    ...
    .prologue
    .line 104
    invoke-virtual {p0}, Landroid/support/v7/internal/view/menu/p;->e()Landroid/content/Context;
...
.method public setHeaderTitle(I)Landroid/view/SubMenu;
    ...
    invoke-super {p0, v0}, Landroid/support/v7/internal/view/menu/f;->a(Ljava/lang/CharSequence;)Landroid/support/v7/internal/view/menu/f;
...
.method public setHeaderTitle(Ljava/lang/CharSequence;)Landroid/view/SubMenu;
    ...
    .prologue
    .line 109
    invoke-super {p0, p1}, Landroid/support/v7/internal/view/menu/f;->a(Ljava/lang/CharSequence;)Landroid/support/v7/internal/view/menu/f;
...
.method public setHeaderView(Landroid/view/View;)Landroid/view/SubMenu;
    ...
    .prologue
    .line 119
    invoke-super {p0, p1}, Landroid/support/v7/internal/view/menu/f;->a(Landroid/view/View;)Landroid/support/v7/internal/view/menu/f;
