...
# direct methods
.method public constructor <init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Landroid/support/v7/internal/view/menu/p;)V
    .locals 6
    ...
    .line 718
    iput-object p3, p0, Landroid/support/v7/widget/ActionMenuPresenter$a;->d:Landroid/support/v7/internal/view/menu/p;

    .line 720
    invoke-virtual {p3}, Landroid/support/v7/internal/view/menu/p;->getItem()Landroid/view/MenuItem;
    ...
    invoke-static {p1}, Landroid/support/v7/widget/ActionMenuPresenter;->e(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/internal/view/menu/m;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ActionMenuPresenter$a;->a(Landroid/support/v7/internal/view/menu/l$a;)V

    .line 729
    invoke-virtual {p3}, Landroid/support/v7/internal/view/menu/p;->size()I
    ...
    .line 731
    invoke-virtual {p3, v0}, Landroid/support/v7/internal/view/menu/p;->getItem(I)Landroid/view/MenuItem;
