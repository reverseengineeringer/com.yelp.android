...
.method public constructor <init>(Lcom/google/android/gms/internal/gu;Ljava/util/Map;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/internal/dj;->mo:Lcom/google/android/gms/internal/gu;

    iput-object p2, p0, Lcom/google/android/gms/internal/dj;->rd:Ljava/util/Map;

    invoke-virtual {p1}, Lcom/google/android/gms/internal/gu;->dI()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/internal/dj;->mContext:Landroid/content/Context;

    return-void
.end method

.method static synthetic a(Lcom/google/android/gms/internal/dj;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lcom/google/android/gms/internal/dj;->mContext:Landroid/content/Context;

    return-object v0
.end method

.method static synthetic b(Lcom/google/android/gms/internal/dj;)Lcom/google/android/gms/internal/gu;
    .locals 1

    iget-object v0, p0, Lcom/google/android/gms/internal/dj;->mo:Lcom/google/android/gms/internal/gu;
...
.method public execute()V
    ...
    iget-object v1, p0, Lcom/google/android/gms/internal/dj;->mContext:Landroid/content/Context;

    invoke-direct {v0, v1}, Lcom/google/android/gms/internal/bl;-><init>(Landroid/content/Context;)V

    invoke-virtual {v0}, Lcom/google/android/gms/internal/bl;->bq()Z

    move-result v0

    if-nez v0, :cond_0

    const-string/jumbo v0, "Store picture feature is not supported on this device."
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/internal/dj;->rd:Ljava/util/Map;
    ...
    :cond_2
    invoke-virtual {p0, v0}, Lcom/google/android/gms/internal/dj;->B(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-static {v1}, Lcom/google/android/gms/internal/gi;->N(Ljava/lang/String;)Z

    move-result v2

    if-nez v2, :cond_3

    const-string/jumbo v0, "Image type not recognized:"
    ...
    iget-object v3, p0, Lcom/google/android/gms/internal/dj;->mContext:Landroid/content/Context;
    ...
    invoke-static {v3, v4}, Lcom/google/android/gms/internal/ga;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v4, "Allow Ad to store image in Picture gallery?"
    ...
    invoke-direct {v4, p0, v0, v1}, Lcom/google/android/gms/internal/dj$1;-><init>(Lcom/google/android/gms/internal/dj;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1}, Lcom/google/android/gms/internal/ga;->c(ILjava/lang/String;)Ljava/lang/String;
