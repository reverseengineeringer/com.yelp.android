...
.method private zza(Landroid/content/Context;Lcom/google/android/gms/internal/jg;I)Landroid/graphics/drawable/Drawable;
    .locals 4
    ...
    invoke-direct {v2, p3, v0}, Lcom/google/android/gms/internal/jg$a;-><init>(II)V

    invoke-virtual {p2, v2}, Lcom/google/android/gms/internal/jg;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_0
    invoke-virtual {p2, v2, v0}, Lcom/google/android/gms/internal/jg;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method protected zza(Landroid/content/res/Resources;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, p2}, Lcom/google/android/gms/internal/je;->a(Landroid/content/res/Resources;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method protected zza(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Lcom/google/android/gms/internal/jd;
    .locals 1
    ...
    instance-of v0, p1, Lcom/google/android/gms/internal/jd;

    if-eqz v0, :cond_0

    check-cast p1, Lcom/google/android/gms/internal/jd;

    invoke-virtual {p1}, Lcom/google/android/gms/internal/jd;->b()Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v0, p1, p2}, Lcom/google/android/gms/internal/jd;-><init>(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method zza(Landroid/content/Context;Landroid/graphics/Bitmap;Z)V
    ...
    invoke-static {p2}, Lcom/google/android/gms/internal/je;->a(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
...
.method zza(Landroid/content/Context;Lcom/google/android/gms/internal/jg;)V
    .locals 3
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/google/android/gms/common/images/zza;->zza(Landroid/content/Context;Lcom/google/android/gms/internal/jg;I)Landroid/graphics/drawable/Drawable;
...
.method zza(Landroid/content/Context;Lcom/google/android/gms/internal/jg;Z)V
    .locals 4
