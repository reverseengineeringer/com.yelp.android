...
.method public static showErrorNotification(ILandroid/content/Context;)V
    ...
    invoke-static {p1}, Lcom/google/android/gms/internal/jw;->a(Landroid/content/Context;)Z
...
.method private static zza(ILandroid/content/Context;Ljava/lang/String;)V
    ...
    sget v0, Lcom/yelp/android/ba/a$e;->common_google_play_services_notification_ticker:I
    ...
    invoke-static {}, Lcom/google/android/gms/internal/kf;->d()Z
    ...
    sget v5, Lcom/yelp/android/ba/a$b;->common_ic_googleplayservices:I
    ...
    sget v2, Lcom/yelp/android/ba/a$b;->common_full_open_on_phone:I

    sget v4, Lcom/yelp/android/ba/a$e;->common_open_on_phone:I
    ...
    :cond_1
    sget v4, Lcom/yelp/android/ba/a$e;->common_google_play_services_notification_ticker:I
    ...
    :cond_5
    new-instance v4, Landroid/support/v4/app/x$d;

    invoke-direct {v4, p1}, Landroid/support/v4/app/x$d;-><init>(Landroid/content/Context;)V

    invoke-virtual {v4, v5}, Landroid/support/v4/app/x$d;->a(I)Landroid/support/v4/app/x$d;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroid/support/v4/app/x$d;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$d;
    ...
    invoke-virtual {v1, v4, v5}, Landroid/support/v4/app/x$d;->a(J)Landroid/support/v4/app/x$d;

    move-result-object v1

    invoke-virtual {v1, v6}, Landroid/support/v4/app/x$d;->a(Z)Landroid/support/v4/app/x$d;

    move-result-object v1

    invoke-virtual {v1, v3}, Landroid/support/v4/app/x$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/x$d;

    move-result-object v1

    invoke-virtual {v1, v0}, Landroid/support/v4/app/x$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$d;

    move-result-object v0

    invoke-virtual {v0, v2}, Landroid/support/v4/app/x$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/x$d;
...
.method public static zza(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;Ljava/lang/String;Landroid/app/Dialog;)V
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/FragmentActivity;->getSupportFragmentManager()Landroid/support/v4/app/l;
    ...
    invoke-virtual {v1, v0, p2}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Landroid/support/v4/app/l;Ljava/lang/String;)V
