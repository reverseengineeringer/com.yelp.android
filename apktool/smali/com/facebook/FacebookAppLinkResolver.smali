...
.method static synthetic access$000(Lorg/json/JSONObject;)Lbolts/e;
    .locals 1

    .prologue
    .line 37
    invoke-static {p0}, Lcom/facebook/FacebookAppLinkResolver;->getAndroidTargetFromJson(Lorg/json/JSONObject;)Lbolts/e;
...
.method private static getAndroidTargetFromJson(Lorg/json/JSONObject;)Lbolts/e;
    .locals 5
    ...
    invoke-direct {v1, v2, v3, v0, v4}, Lbolts/e;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)V
...
# virtual methods
.method public getAppLinkFromUrlInBackground(Landroid/net/Uri;)Lbolts/k;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 62
    invoke-virtual {p0, v0}, Lcom/facebook/FacebookAppLinkResolver;->getAppLinkFromUrlsInBackground(Ljava/util/List;)Lbolts/k;
    ...
    invoke-virtual {v0, v1}, Lbolts/k;->b(Lbolts/j;)Lbolts/k;
...
.method public getAppLinkFromUrlsInBackground(Ljava/util/List;)Lbolts/k;
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 103
    invoke-static {v4}, Lbolts/k;->a(Ljava/lang/Object;)Lbolts/k;
    ...
    const-string/jumbo v2, "%s.fields(%s,%s)"
    ...
    const-string/jumbo v9, "app_links"
    ...
    invoke-direct {v5, p0, v7, v4, v6}, Lcom/facebook/FacebookAppLinkResolver$2;-><init>(Lcom/facebook/FacebookAppLinkResolver;Lbolts/s;Ljava/util/Map;Ljava/util/HashSet;)V
    ...
    .line 179
    invoke-virtual {v7}, Lbolts/s;->a()Lbolts/k;
