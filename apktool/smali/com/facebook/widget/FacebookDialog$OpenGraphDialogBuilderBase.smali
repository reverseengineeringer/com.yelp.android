...
.method public constructor <init>(Landroid/app/Activity;Lcom/facebook/model/OpenGraphAction;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "\'actionType\' must match the type of \'action\' if it is specified. Consider using OpenGraphDialogBuilderBase(Activity activity, OpenGraphAction action, String previewPropertyName) instead."
...
.method protected getMethodArguments()Landroid/os/Bundle;
    ...
    .line 1803
    const-string/jumbo v1, "PREVIEW_PROPERTY_NAME"
...
.method protected setBundleExtras(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .prologue
    .line 1786
    const-string/jumbo v0, "com.facebook.platform.extra.PREVIEW_PROPERTY_NAME"
    ...
    .line 1787
    const-string/jumbo v0, "com.facebook.platform.extra.ACTION_TYPE"
    ...
    .line 1788
    const-string/jumbo v0, "com.facebook.platform.extra.DATA_FAILURES_FATAL"
...
.method public setImageAttachmentFilesForAction(Ljava/util/List;Z)Lcom/facebook/widget/FacebookDialog$OpenGraphDialogBuilderBase;
    ...
    .prologue
    .line 1589
    const-string/jumbo v0, "bitmapFiles"
    ...
    const-string/jumbo v1, "Can not set attachments prior to setting action."
...
.method public setImageAttachmentFilesForObject(Ljava/lang/String;Ljava/util/List;Z)Lcom/facebook/widget/FacebookDialog$OpenGraphDialogBuilderBase;
    ...
    .prologue
    .line 1740
    const-string/jumbo v0, "objectProperty"
...
.method updateObjectAttachmentUrls(Ljava/lang/String;Ljava/util/List;Z)V
    ...
    const-string/jumbo v2, "Action does not contain a property \'"
    ...
    const-string/jumbo v2, "\' is not a graph object"
    ...
    const-string/jumbo v2, "The Open Graph object in \'"
    ...
    const-string/jumbo v2, "\' is not marked for creation"
