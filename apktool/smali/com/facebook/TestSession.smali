...
.method constructor <init>(Landroid/app/Activity;Ljava/util/List;Lcom/facebook/TokenCachingStrategy;Ljava/lang/String;Lcom/facebook/TestSession$Mode;)V
    ...
    const-string/jumbo v1, "testApplicationId"
    ...
    const-string/jumbo v1, "testApplicationSecret"
...
.method private createTestAccountAndFinishAuth()Lcom/facebook/TestSession$TestAccount;
    ...
    .line 386
    :cond_0
    const-string/jumbo v0, "%s/accounts/test-users"
...
.method private deleteTestAccount(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 421
    const-string/jumbo v0, "FacebookSDK.TestSession"

    const-string/jumbo v2, "Could not delete test account %s: %s"
    ...
    const-string/jumbo v1, "Could not delete test account %s: unknown reason"
...
.method private static declared-synchronized retrieveTestAccountsForAppIfNeeded()V
    ...
    const-string/jumbo v4, "app/accounts/test-users"
    ...
    const-string/jumbo v4, "{result=testUsers:$.data.*.id}"
    ...
    const-string/jumbo v2, "Unexpected number of results from TestUsers batch query"
...
.method public static declared-synchronized setTestApplicationId(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "Can\'t have more than one test application ID"
...
.method public static declared-synchronized setTestApplicationSecret(Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "Can\'t have more than one test application secret"
...
.method public final toString()Ljava/lang/String;
    ...
    const-string/jumbo v2, " testUserId:"
